...
class CardInfoLookupApi(object):
    ...
    def card_info_lookup(self, content_type, client_request_id, api_key, timestamp, card_info_lookup_request, **kwargs):  # noqa: E501
        ...
        :param CardInfoLookupRequest card_info_lookup_request: Card information lookup payload. (required)
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.card_info_lookup_with_http_info(content_type, client_request_id, api_key, timestamp, card_info_lookup_request, **kwargs)  # noqa: E501
            return data
    ...
    def card_info_lookup_with_http_info(self, content_type, client_request_id, api_key, timestamp, card_info_lookup_request, **kwargs):  # noqa: E501
        ...
        if ('content_type' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `content_type` when calling `card_info_lookup`")  # noqa: E501
        ...
        if ('client_request_id' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `client_request_id` when calling `card_info_lookup`")  # noqa: E501
        # verify the required parameter 'api_key' is set
        if ('api_key' not in local_var_params or
                local_var_params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `card_info_lookup`")  # noqa: E501
        # verify the required parameter 'timestamp' is set
        if ('timestamp' not in local_var_params or
                local_var_params['timestamp'] is None):
            raise ValueError("Missing the required parameter `timestamp` when calling `card_info_lookup`")  # noqa: E501
        ...
        if ('card_info_lookup_request' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `card_info_lookup_request` when calling `card_info_lookup`")  # noqa: E501
