...
class InformationLookupApi(object):
    ...
    def card_info_lookup_with_http_info(self, content_type, client_request_id, api_key, timestamp, card_info_lookup_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('card_info_lookup_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['card_info_lookup_request'] is None):  # noqa: E501
    ...
    def lookup_account_with_http_info(self, content_type, client_request_id, api_key, timestamp, account_info_lookup_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('account_info_lookup_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['account_info_lookup_request'] is None):  # noqa: E501
