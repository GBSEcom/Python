...
class AuthenticationApi(object):
    ...
    def authentication_access_tokens_post(self, content_type, client_request_id, api_key, timestamp, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.authentication_access_tokens_post_with_http_info(content_type, client_request_id, api_key, timestamp, **kwargs)  # noqa: E501
            return data
    ...
    def authentication_access_tokens_post_with_http_info(self, content_type, client_request_id, api_key, timestamp, **kwargs):  # noqa: E501
        ...
        if ('content_type' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `content_type` when calling `authentication_access_tokens_post`")  # noqa: E501
        ...
        if ('client_request_id' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `client_request_id` when calling `authentication_access_tokens_post`")  # noqa: E501
        # verify the required parameter 'api_key' is set
        if ('api_key' not in local_var_params or
                local_var_params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `authentication_access_tokens_post`")  # noqa: E501
        # verify the required parameter 'timestamp' is set
        if ('timestamp' not in local_var_params or
                local_var_params['timestamp'] is None):
            raise ValueError("Missing the required parameter `timestamp` when calling `authentication_access_tokens_post`")  # noqa: E501
