...
class OrderApi(object):
    ...
    def submit_secondary_transaction_from_order(self, content_type, client_request_id, api_key, timestamp, order_id, secondary_transaction, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.submit_secondary_transaction_from_order_with_http_info(content_type, client_request_id, api_key, timestamp, order_id, secondary_transaction, **kwargs)  # noqa: E501
            return data
    ...
    def submit_secondary_transaction_from_order_with_http_info(self, content_type, client_request_id, api_key, timestamp, order_id, secondary_transaction, **kwargs):  # noqa: E501
        ...
        if ('content_type' not in local_var_params or
                local_var_params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `submit_secondary_transaction_from_order`")  # noqa: E501
        # verify the required parameter 'client_request_id' is set
        if ('client_request_id' not in local_var_params or
                local_var_params['client_request_id'] is None):
            raise ValueError("Missing the required parameter `client_request_id` when calling `submit_secondary_transaction_from_order`")  # noqa: E501
        # verify the required parameter 'api_key' is set
        if ('api_key' not in local_var_params or
                local_var_params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `submit_secondary_transaction_from_order`")  # noqa: E501
        # verify the required parameter 'timestamp' is set
        if ('timestamp' not in local_var_params or
                local_var_params['timestamp'] is None):
            raise ValueError("Missing the required parameter `timestamp` when calling `submit_secondary_transaction_from_order`")  # noqa: E501
        # verify the required parameter 'order_id' is set
        if ('order_id' not in local_var_params or
                local_var_params['order_id'] is None):
            raise ValueError("Missing the required parameter `order_id` when calling `submit_secondary_transaction_from_order`")  # noqa: E501
        ...
        if ('secondary_transaction' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `secondary_transaction` when calling `submit_secondary_transaction_from_order`")  # noqa: E501
