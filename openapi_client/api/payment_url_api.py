...
class PaymentURLApi(object):
    ...
    def create_payment_url_with_http_info(self, content_type, client_request_id, api_key, timestamp, payment_url_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('payment_url_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['payment_url_request'] is None):  # noqa: E501
    ...
    def delete_payment_url_with_http_info(self, content_type, client_request_id, api_key, timestamp, **kwargs):  # noqa: E501
        ...
        if 'payment_url_id' in local_var_params and local_var_params['payment_url_id'] is not None:  # noqa: E501
            query_params.append(('paymentUrlId', local_var_params['payment_url_id']))  # noqa: E501
        if 'transaction_time' in local_var_params and local_var_params['transaction_time'] is not None:  # noqa: E501
