...
class Card(object):
    ...
    def __init__(self, ta_token=None, ta_token_key=None, cardholder_name=None, card_number=None, exp_date=None, cvv=None, issuer=None, card_reissued_number=None, local_vars_configuration=None):  # noqa: E501
