...
class Payment(object):
    ...
    def __init__(self, payment_type=None, method=None, pin_present=None, entry_method=None, issuer_response=None, issuer_approved_amount=None, issuer_card_balance=None, verification_avs=None, verification3ds=None, verification_cvv=None, user_defined=None, local_vars_configuration=None):  # noqa: E501
    ...
    def pin_present(self, pin_present):
        ...
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and pin_present is None:  # noqa: E501
    ...
    def entry_method(self, entry_method):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and entry_method is None:  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation and entry_method not in allowed_values:  # noqa: E501
            raise ValueError(
