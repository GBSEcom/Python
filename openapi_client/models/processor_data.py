...
class ProcessorData(object):
    ...
    def __init__(self, reference_number=None, authorization_code=None, response_code=None, network=None, association_response_code=None, response_message=None, avs_response=None, security_code_response=None, merchant_advice_code_indicator=None, response_indicator=None, debit_receipt_number=None, local_vars_configuration=None):  # noqa: E501
    ...
    def security_code_response(self, security_code_response):
        ...
        if self.local_vars_configuration.client_side_validation and security_code_response not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def merchant_advice_code_indicator(self, merchant_advice_code_indicator):
        ...
        if (self.local_vars_configuration.client_side_validation and
                merchant_advice_code_indicator is not None and not re.search(r'[0-9]{2}', merchant_advice_code_indicator)):  # noqa: E501
