...
class EncryptedApplePayHeader(object):
    ...
    def __init__(self, application_data_hash=None, ephemeral_public_key=None, public_key_hash=None, transaction_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def ephemeral_public_key(self, ephemeral_public_key):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and ephemeral_public_key is None:  # noqa: E501
            raise ValueError("Invalid value for `ephemeral_public_key`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                ephemeral_public_key is not None and not re.search(r'^(?!\s*$).+', ephemeral_public_key)):  # noqa: E501
    ...
    def public_key_hash(self, public_key_hash):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and public_key_hash is None:  # noqa: E501
            raise ValueError("Invalid value for `public_key_hash`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                public_key_hash is not None and not re.search(r'^(?!\s*$).+', public_key_hash)):  # noqa: E501
    ...
    def transaction_id(self, transaction_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                transaction_id is not None and not re.search(r'^(?!\s*$).+', transaction_id)):  # noqa: E501
