...
class ChinaDomesticPaymentMethodAllOf(object):
    ...
    def __init__(self, china_domestic=None, brand=None, local_vars_configuration=None):  # noqa: E501
    ...
    def china_domestic(self, china_domestic):
        ...
        :type: ChinaDomestic
        """
        if self.local_vars_configuration.client_side_validation and china_domestic is None:  # noqa: E501
