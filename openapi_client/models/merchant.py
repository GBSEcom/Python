...
class Merchant(object):
    ...
    def __init__(self, mcc=None, merchant_unique_id=None, location=None, user_defined=None, local_vars_configuration=None):  # noqa: E501
    ...
    def merchant_unique_id(self, merchant_unique_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and merchant_unique_id is None:  # noqa: E501
            raise ValueError("Invalid value for `merchant_unique_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                merchant_unique_id is not None and not re.search(r'^(?!\s*$).+', merchant_unique_id)):  # noqa: E501
