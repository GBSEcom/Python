...
class AirlineTravelRoute(object):
    ...
    def __init__(self, departure_date=None, origin=None, destination=None, carrier_code=None, service_class=None, stopover_type=None, fare_basis_code=None, departure_tax=None, flight_number=None, local_vars_configuration=None):  # noqa: E501
    ...
    def origin(self, origin):
        ...
        if (self.local_vars_configuration.client_side_validation and
                origin is not None and len(origin) > 3):
    ...
    def destination(self, destination):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                destination is not None and len(destination) > 3):
    ...
    def service_class(self, service_class):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                service_class is not None and len(service_class) > 1):
    ...
    def stopover_type(self, stopover_type):
        ...
        if self.local_vars_configuration.client_side_validation and stopover_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def fare_basis_code(self, fare_basis_code):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                fare_basis_code is not None and len(fare_basis_code) > 2):
    ...
    def departure_tax(self, departure_tax):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                departure_tax is not None and departure_tax > 999999999999):  # noqa: E501
    ...
    def flight_number(self, flight_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                flight_number is not None and len(flight_number) > 10):
