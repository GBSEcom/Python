...
class EncryptedGooglePayData(object):
    ...
    def __init__(self, encrypted_message=None, ephemeral_public_key=None, tag=None, local_vars_configuration=None):  # noqa: E501
    ...
    def encrypted_message(self, encrypted_message):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and encrypted_message is None:  # noqa: E501
            raise ValueError("Invalid value for `encrypted_message`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                encrypted_message is not None and not re.search(r'^(?!\s*$).+', encrypted_message)):  # noqa: E501
    ...
    def tag(self, tag):
        ...
        if (self.local_vars_configuration.client_side_validation and
                tag is not None and not re.search(r'^(?!\s*$).+', tag)):  # noqa: E501
