...
class PaymentTokenSaleTransaction(object):
    ...
    def __init__(self, request_type=None, store_id=None, merchant_transaction_id=None, transaction_amount=None, transaction_origin=None, order=None, payment_method=None, stored_credentials=None, settlement_split=None, currency_conversion=None):  # noqa: E501
