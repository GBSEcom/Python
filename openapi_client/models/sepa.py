...
class Sepa(object):
    ...
    def __init__(self, iban=None, name=None, country=None, email=None, mandate=None, local_vars_configuration=None):  # noqa: E501
    ...
    def iban(self, iban):
        ...
        if (self.local_vars_configuration.client_side_validation and
                iban is not None and not re.search(r'^(?!\s*$).+', iban)):  # noqa: E501
    ...
    def name(self, name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                name is not None and len(name) > 96):
    ...
    def mandate(self, mandate):
        ...
        :type: SepaMandate
        """
        if self.local_vars_configuration.client_side_validation and mandate is None:  # noqa: E501
