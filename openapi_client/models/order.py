...
class Order(object):
    ...
    def __init__(self, order_id=None, billing=None, shipping=None, industry_specific_extensions=None, purchase_card=None, installment_options=None, revolving_options=None, soft_descriptor=None, additional_details=None, bancontact_qr=None):  # noqa: E501
