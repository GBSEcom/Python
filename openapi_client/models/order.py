...
class Order(object):
    ...
    def __init__(self, order_id=None, billing=None, shipping=None, industry_specific_extensions=None, purchase_card=None, installment_options=None, soft_descriptor=None, additional_details=None, bancontact_qr=None, local_vars_configuration=None):  # noqa: E501
    ...
    def order_id(self, order_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                order_id is not None and len(order_id) > 100):
