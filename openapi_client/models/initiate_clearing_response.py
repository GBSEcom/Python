...
class InitiateClearingResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, request_status=None, clearing_details=None, endpoint_responses=None, local_vars_configuration=None):  # noqa: E501
