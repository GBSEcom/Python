...
class PaymentCardSaleTransactionAllOf(object):
    ...
    def __init__(self, request_type=None, payment_method=None, stored_credentials=None, settlement_split=None, create_token=None, currency_conversion=None, authentication_request=None, authentication_result=None, local_vars_configuration=None):  # noqa: E501
