...
class PaymentFacilitator(object):
    ...
    def __init__(self, external_merchant_id=None, payment_facilitator_id=None, sale_organization_id=None, name=None, sub_merchant_data=None, local_vars_configuration=None):  # noqa: E501
    ...
    def external_merchant_id(self, external_merchant_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and external_merchant_id is None:  # noqa: E501
            raise ValueError("Invalid value for `external_merchant_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                external_merchant_id is not None and not re.search(r'^(?!\s*$).+', external_merchant_id)):  # noqa: E501
    ...
    def payment_facilitator_id(self, payment_facilitator_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and payment_facilitator_id is None:  # noqa: E501
            raise ValueError("Invalid value for `payment_facilitator_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                payment_facilitator_id is not None and not re.search(r'\d{1,11}', payment_facilitator_id)):  # noqa: E501
    ...
    def sale_organization_id(self, sale_organization_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                sale_organization_id is not None and not re.search(r'\d{1,11}', sale_organization_id)):  # noqa: E501
