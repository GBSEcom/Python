...
class PaymentFacilitator(object):
    ...
    def payment_facilitator_id(self, payment_facilitator_id):
        ...
        if payment_facilitator_id is not None and not re.search(r'[a-zA-Z0-9]{1,11}', payment_facilitator_id):  # noqa: E501
            raise ValueError(r"Invalid value for `payment_facilitator_id`, must be a follow pattern or equal to `/[a-zA-Z0-9]{1,11}/`")  # noqa: E501
