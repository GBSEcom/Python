...
class FraudSettingsResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, store_id=None, blocked_card_numbers=None, blocked_names=None, blocked_domain_names=None, blocked_ip_or_class_c_addresses=None, maximum_purchase_amount=None, lockout_time=None, country_profile=None, local_vars_configuration=None):  # noqa: E501
