...
class PaymentTokenSaleTransactionAllOf(object):
    ...
    def __init__(self, payment_method=None, stored_credentials=None, settlement_split=None, currency_conversion=None, authentication_request=None, authentication_result=None):  # noqa: E501
