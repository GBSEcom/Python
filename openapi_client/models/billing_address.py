...
class BillingAddress(object):
    ...
    def __init__(self, first_name=None, last_name=None, middle_name=None, street=None, street2=None, state_province=None, city=None, country=None, phone=None, zip_postal_code=None, local_vars_configuration=None):  # noqa: E501
