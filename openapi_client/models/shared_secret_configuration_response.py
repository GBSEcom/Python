...
class SharedSecretConfigurationResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, store_id=None, shared_secret=None, response_message=None, response_timestamp=None, local_vars_configuration=None):  # noqa: E501
