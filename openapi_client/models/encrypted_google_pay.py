...
class EncryptedGooglePay(object):
    ...
    def __init__(self, data=None, signature=None, version=None, local_vars_configuration=None):  # noqa: E501
    ...
    def version(self, version):
        ...
        if (self.local_vars_configuration.client_side_validation and
                version is not None and not re.search(r'^(?!\s*$).+', version)):  # noqa: E501
