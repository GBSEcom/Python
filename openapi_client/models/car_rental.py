...
class CarRental(object):
    ...
    def __init__(self, agreement_number=None, renter_name=None, return_city=None, return_date=None, pickup_date=None, rental_class_id=None, extra_charges=None, no_show_indicator=None, local_vars_configuration=None):  # noqa: E501
    ...
    def agreement_number(self, agreement_number):
        ...
        if (self.local_vars_configuration.client_side_validation and
                agreement_number is not None and len(agreement_number) > 20):
    ...
    def renter_name(self, renter_name):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                renter_name is not None and len(renter_name) > 20):
    ...
    def return_city(self, return_city):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                return_city is not None and len(return_city) > 20):
    ...
    def rental_class_id(self, rental_class_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                rental_class_id is not None and len(rental_class_id) > 6):
