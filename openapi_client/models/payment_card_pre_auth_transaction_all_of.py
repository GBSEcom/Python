...
class PaymentCardPreAuthTransactionAllOf(object):
    ...
    def __init__(self, payment_method=None, stored_credentials=None, create_token=None, split_shipment=None, settlement_split=None, authentication_request=None, authentication_result=None, decremental_flag=False, local_vars_configuration=None):  # noqa: E501
