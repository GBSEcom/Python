...
class RecurringPaymentDetails(object):
    ...
    def __init__(self, store_id=None, purchase_order_number=None, invoice_number=None, creation_date=None, start_date=None, next_attempt_date=None, transaction_amount=None, payment_method_details=None, frequency=None, number_of_payments=None, run_count=None, state=None, comments=None, local_vars_configuration=None):  # noqa: E501
    ...
    def run_count(self, run_count):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                run_count is not None and run_count > 999):  # noqa: E501
            raise ValueError("Invalid value for `run_count`, must be a value less than or equal to `999`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                run_count is not None and run_count < 0):  # noqa: E501
