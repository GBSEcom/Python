...
class PaymentTokenizationResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, request_status=None, request_time=None, brand=None, country=None, payment_token=None, payment_card=None, processor=None, order_id=None, local_vars_configuration=None):  # noqa: E501
