...
class InstallmentOptions(object):
    ...
    def __init__(self, number_of_installments=None, installments_interest=None, installment_delay_months=None, recurring_type=None, merchant_advice_code_supported=None, local_vars_configuration=None):  # noqa: E501
    ...
    def number_of_installments(self, number_of_installments):
        ...
        if (self.local_vars_configuration.client_side_validation and
                number_of_installments is not None and number_of_installments > 99):  # noqa: E501
            raise ValueError("Invalid value for `number_of_installments`, must be a value less than or equal to `99`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                number_of_installments is not None and number_of_installments < 1):  # noqa: E501
    ...
    def installment_delay_months(self, installment_delay_months):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                installment_delay_months is not None and installment_delay_months > 99):  # noqa: E501
            raise ValueError("Invalid value for `installment_delay_months`, must be a value less than or equal to `99`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                installment_delay_months is not None and installment_delay_months < 1):  # noqa: E501
    ...
    def recurring_type(self, recurring_type):
        ...
        if self.local_vars_configuration.client_side_validation and recurring_type not in allowed_values:  # noqa: E501
            raise ValueError(
