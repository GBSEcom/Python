...
class PurchaseCardsLevel2(object):
    ...
    def __init__(self, customer_reference_id=None, supplier_invoice_number=None, supplier_vat_registration_number=None, total_discount_amount_and_rate=None, vat_shipping_amount_and_rate=None, local_vars_configuration=None):  # noqa: E501
    ...
    def customer_reference_id(self, customer_reference_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                customer_reference_id is not None and len(customer_reference_id) > 20):
    ...
    def supplier_invoice_number(self, supplier_invoice_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                supplier_invoice_number is not None and len(supplier_invoice_number) > 30):
    ...
    def supplier_vat_registration_number(self, supplier_vat_registration_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                supplier_vat_registration_number is not None and len(supplier_vat_registration_number) > 30):
