...
class EncryptedApplePay(object):
    ...
    def __init__(self, data=None, header=None, signature=None, version=None, application_data=None, merchant_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def data(self, data):
        ...
        if (self.local_vars_configuration.client_side_validation and
                data is not None and not re.search(r'^(?!\s*$).+', data)):  # noqa: E501
    ...
    def signature(self, signature):
        ...
        if (self.local_vars_configuration.client_side_validation and
                signature is not None and not re.search(r'^(?!\s*$).+', signature)):  # noqa: E501
    ...
    def merchant_id(self, merchant_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and merchant_id is None:  # noqa: E501
            raise ValueError("Invalid value for `merchant_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                merchant_id is not None and not re.search(r'^(?!\s*$).+', merchant_id)):  # noqa: E501
