...
class SubMerchantData(object):
    ...
    def __init__(self, mcc=None, legal_name=None, timezone=None, address=None, document=None, merchant_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def mcc(self, mcc):
        ...
        if (self.local_vars_configuration.client_side_validation and
                mcc is not None and not re.search(r'[0-9]{4}', mcc)):  # noqa: E501
    ...
    def legal_name(self, legal_name):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                legal_name is not None and len(legal_name) > 100):
    ...
    def timezone(self, timezone):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                timezone is not None and len(timezone) > 500):
    ...
    def merchant_id(self, merchant_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                merchant_id is not None and len(merchant_id) > 50):
