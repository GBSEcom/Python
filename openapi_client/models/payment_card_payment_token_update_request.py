...
class PaymentCardPaymentTokenUpdateRequest(object):
    ...
    def __init__(self, request_type=None, store_id=None, payment_tokens=None, local_vars_configuration=None):  # noqa: E501
    ...
    def payment_tokens(self, payment_tokens):
        ...
        """
        if self.local_vars_configuration.client_side_validation and payment_tokens is None:  # noqa: E501
