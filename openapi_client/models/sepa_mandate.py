...
class SepaMandate(object):
    ...
    def __init__(self, reference=None, url=None, signature_date=None, type='SINGLE', local_vars_configuration=None):  # noqa: E501
    ...
    def reference(self, reference):
        ...
        if (self.local_vars_configuration.client_side_validation and
                reference is not None and not re.search(r'[A-Za-z0-9:?\/+(),. -]{1,35}', reference)):  # noqa: E501
    ...
    def signature_date(self, signature_date):
        ...
        :type: date
        """
        # if self.local_vars_configuration.client_side_validation and signature_date is None:  # noqa: E501
