...
class Secure3D10AuthenticationUpdateRequest(object):
    ...
    def __init__(self, store_id=None, authentication_type=None, billing_address=None, payer_authentication_response=None, merchant_data=None, security_code=None, local_vars_configuration=None):  # noqa: E501
