...
class AirlineAncillaryServiceCategory(object):
    ...
    def __init__(self, service_category=None, local_vars_configuration=None):  # noqa: E501
    ...
    def service_category(self, service_category):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and service_category is None:  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation and service_category not in allowed_values:  # noqa: E501
            raise ValueError(
