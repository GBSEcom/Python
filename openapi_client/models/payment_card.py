...
class PaymentCard(object):
    ...
    def __init__(self, number=None, expiry_date=None, security_code=None, payment_tokenization=None, card_function=None, cardholder_name=None, authentication_request=None, authentication_result=None, bin=None, last4=None, brand=None, issuing_country=None):  # noqa: E501
    ...
    def number(self, number):
        ...
        if number is not None and len(number) > 19:
            raise ValueError("Invalid value for `number`, length must be less than or equal to `19`")  # noqa: E501
        if number is not None and len(number) < 13:
            raise ValueError("Invalid value for `number`, length must be greater than or equal to `13`")  # noqa: E501
    ...
    def payment_tokenization(self):
        """Gets the payment_tokenization of this PaymentCard.  # noqa: E501


        :return: The payment_tokenization of this PaymentCard.  # noqa: E501
    ...
    def payment_tokenization(self, payment_tokenization):
        """Sets the payment_tokenization of this PaymentCard.


        :param payment_tokenization: The payment_tokenization of this PaymentCard.  # noqa: E501
    ...
    def card_function(self):
        ...
        Card function. Optional, valid values are CREDIT or DEBIT.  # noqa: E501
    ...
    def cardholder_name(self):
        ...
        Name of the cardholder on the card  # noqa: E501
    ...
    def issuing_country(self):
        """Gets the issuing_country of this PaymentCard.  # noqa: E501

        The issuing country  # noqa: E501

        :return: The issuing_country of this PaymentCard.  # noqa: E501
        :rtype: str
        """
    ...
    def issuing_country(self, issuing_country):
        """Sets the issuing_country of this PaymentCard.

        The issuing country  # noqa: E501

        :param issuing_country: The issuing_country of this PaymentCard.  # noqa: E501
        :type: str
        """
