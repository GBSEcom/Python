...
class PaymentCard(object):
    ...
    def __init__(self, number=None, expiry_date=None, security_code=None, card_function=None, cardholder_name=None, bin=None, last4=None, brand=None, local_vars_configuration=None):  # noqa: E501
    ...
    def number(self, number):
        ...
        if (self.local_vars_configuration.client_side_validation and
                number is not None and not re.search(r'[0-9]{13,19}', number)):  # noqa: E501
    ...
    def security_code(self, security_code):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                security_code is not None and len(security_code) > 4):
            raise ValueError("Invalid value for `security_code`, length must be less than or equal to `4`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                security_code is not None and len(security_code) < 3):
