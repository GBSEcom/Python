...
class Airline(object):
    ...
    def passenger_name(self, passenger_name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                passenger_name is not None and len(passenger_name) > 30):
    ...
    def ticket_number(self, ticket_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                ticket_number is not None and len(ticket_number) > 20):
    ...
    def issuing_carrier(self, issuing_carrier):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                issuing_carrier is not None and len(issuing_carrier) > 20):
    ...
    def carrier_name(self, carrier_name):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                carrier_name is not None and len(carrier_name) > 20):
    ...
    def travel_agency_iata_code(self, travel_agency_iata_code):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                travel_agency_iata_code is not None and len(travel_agency_iata_code) > 20):
    ...
    def travel_agency_name(self, travel_agency_name):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                travel_agency_name is not None and len(travel_agency_name) > 30):
    ...
    def airline_plan_number(self, airline_plan_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                airline_plan_number is not None and len(airline_plan_number) > 2):
    ...
    def airline_invoice_number(self, airline_invoice_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                airline_invoice_number is not None and len(airline_invoice_number) > 6):
    ...
    def reservation_system(self, reservation_system):
        ...
        if self.local_vars_configuration.client_side_validation and reservation_system not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def related_ticket_number(self, related_ticket_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                related_ticket_number is not None and len(related_ticket_number) > 20):
