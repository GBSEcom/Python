...
class AdditionalDetails(object):
    ...
    def __init__(self, comments=None, invoice_number=None, purchase_order_number=None, operator_id=None, sales_system_id=None, ipg_deferred_auth=None, high_risk_purchase_indicator=None, local_vars_configuration=None):  # noqa: E501
    ...
    def invoice_number(self, invoice_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                invoice_number is not None and len(invoice_number) > 48):
    ...
    def purchase_order_number(self, purchase_order_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                purchase_order_number is not None and len(purchase_order_number) > 128):
    ...
    def operator_id(self, operator_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                operator_id is not None and len(operator_id) > 35):
            raise ValueError("Invalid value for `operator_id`, length must be less than or equal to `35`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                operator_id is not None and not re.search(r'^\S$|^\S.*\S$', operator_id)):  # noqa: E501
    ...
    def sales_system_id(self, sales_system_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                sales_system_id is not None and len(sales_system_id) > 50):
            raise ValueError("Invalid value for `sales_system_id`, length must be less than or equal to `50`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sales_system_id is not None and not re.search(r'^\S$|^\S.*\S$', sales_system_id)):  # noqa: E501
