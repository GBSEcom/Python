...
class AdditionalDetails(object):
    ...
    def __init__(self, comments=None, invoice_number=None, purchase_order_number=None, operator_id=None, sales_system_id=None, ipg_deferred_auth=None):  # noqa: E501
    ...
    def operator_id(self, operator_id):
        ...
        if operator_id is not None and not re.search(r'^\S$|^\S[\s\S]*\S$', operator_id):  # noqa: E501
            raise ValueError(r"Invalid value for `operator_id`, must be a follow pattern or equal to `/^\S$|^\S[\s\S]*\S$/`")  # noqa: E501
    ...
    def sales_system_id(self, sales_system_id):
        ...
        if sales_system_id is not None and not re.search(r'^\S$|^\S[\s\S]*\S$', sales_system_id):  # noqa: E501
            raise ValueError(r"Invalid value for `sales_system_id`, must be a follow pattern or equal to `/^\S$|^\S[\s\S]*\S$/`")  # noqa: E501
