...
class ChinaDomestic(object):
    ...
    def __init__(self, product_code=None, product_quantity=None, product_price=None, product_description=None, redirect_url=None, limit_card_function_to_debit=None, customer_id=None, bank_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def product_code(self, product_code):
        ...
        if (self.local_vars_configuration.client_side_validation and
                product_code is not None and len(product_code) > 32):
            raise ValueError("Invalid value for `product_code`, length must be less than or equal to `32`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                product_code is not None and not re.search(r'^(?!\s*$).+', product_code)):  # noqa: E501
    ...
    def product_quantity(self, product_quantity):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and product_quantity is None:  # noqa: E501
            raise ValueError("Invalid value for `product_quantity`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                product_quantity is not None and product_quantity < 1):  # noqa: E501
    ...
    def product_price(self, product_price):
        ...
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and product_price is None:  # noqa: E501
    ...
    def product_description(self, product_description):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and product_description is None:  # noqa: E501
            raise ValueError("Invalid value for `product_description`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                product_description is not None and len(product_description) > 100):
            raise ValueError("Invalid value for `product_description`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                product_description is not None and not re.search(r'^(?!\s*$).+', product_description)):  # noqa: E501
    ...
    def redirect_url(self, redirect_url):
        ...
        if (self.local_vars_configuration.client_side_validation and
                redirect_url is not None and len(redirect_url) > 1024):
            raise ValueError("Invalid value for `redirect_url`, length must be less than or equal to `1024`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                redirect_url is not None and not re.search(r'^(?!\s*$).+', redirect_url)):  # noqa: E501
    ...
    def customer_id(self, customer_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                customer_id is not None and len(customer_id) > 32):
    ...
    def bank_id(self, bank_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                bank_id is not None and len(bank_id) > 8):
