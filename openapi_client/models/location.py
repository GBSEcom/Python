...
class Location(object):
    ...
    def __init__(self, location_id=None, merchant_address=None, hierarchy=None, timezone_offset=None, user_defined=None, local_vars_configuration=None):  # noqa: E501
