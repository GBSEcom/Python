...
class DeviceNetworks(object):
    ...
    def __init__(self, network_type=None, ip=None, phone_number=None, carrier_name=None, mobile_country_code=None, mobile_network_code=None, subscription_identification_number=None, location_area_code=None, cell_id=None, standard=None, mac=None, ssid=None, bssid=None, user_defined=None):  # noqa: E501
        """DeviceNetworks - a model defined in OpenAPI"""  # noqa: E501
    ...
    def network_type(self):
        """Gets the network_type of this DeviceNetworks.  # noqa: E501

        Defines the type of network associated with the device.  # noqa: E501

        :return: The network_type of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def network_type(self, network_type):
        """Sets the network_type of this DeviceNetworks.

        Defines the type of network associated with the device.  # noqa: E501

        :param network_type: The network_type of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ip(self):
        """Gets the ip of this DeviceNetworks.  # noqa: E501

        The IPv4 or IPv6 address of the device if the network assigned one.  # noqa: E501

        :return: The ip of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        """Sets the ip of this DeviceNetworks.

        The IPv4 or IPv6 address of the device if the network assigned one.  # noqa: E501

        :param ip: The ip of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    def phone_number(self):
        """Gets the phone_number of this DeviceNetworks.  # noqa: E501
        ...
        :return: The phone_number of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this DeviceNetworks.

        The devices primary phone number. This value should be supplied directly without any transformation (e.g. removal of spaces, hyphens or parentheses). If this data is available in segregated fields, it should be concatenated using a blank space (\" \") as a separator.  # noqa: E501

        :param phone_number: The phone_number of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    def carrier_name(self):
        """Gets the carrier_name of this DeviceNetworks.  # noqa: E501

        The network carrier name.  # noqa: E501

        :return: The carrier_name of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def carrier_name(self, carrier_name):
        """Sets the carrier_name of this DeviceNetworks.

        The network carrier name.  # noqa: E501

        :param carrier_name: The carrier_name of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    def mobile_country_code(self):
        """Gets the mobile_country_code of this DeviceNetworks.  # noqa: E501

        The Mobile Country Code (MCC) as described in the ITUs E.212 specification.  # noqa: E501

        :return: The mobile_country_code of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def mobile_country_code(self, mobile_country_code):
        """Sets the mobile_country_code of this DeviceNetworks.

        The Mobile Country Code (MCC) as described in the ITUs E.212 specification.  # noqa: E501

        :param mobile_country_code: The mobile_country_code of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    def mobile_network_code(self):
        """Gets the mobile_network_code of this DeviceNetworks.  # noqa: E501

        The Mobile Network Code (MNC) as described in the ITUs E.212 specification.  # noqa: E501

        :return: The mobile_network_code of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def mobile_network_code(self, mobile_network_code):
        """Sets the mobile_network_code of this DeviceNetworks.

        The Mobile Network Code (MNC) as described in the ITUs E.212 specification.  # noqa: E501

        :param mobile_network_code: The mobile_network_code of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    def subscription_identification_number(self):
        """Gets the subscription_identification_number of this DeviceNetworks.  # noqa: E501

        The Mobile Subscription Identification Number code (MSIN) as described in the ITUs E.212 specification.  # noqa: E501

        :return: The subscription_identification_number of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_identification_number(self, subscription_identification_number):
        """Sets the subscription_identification_number of this DeviceNetworks.

        The Mobile Subscription Identification Number code (MSIN) as described in the ITUs E.212 specification.  # noqa: E501

        :param subscription_identification_number: The subscription_identification_number of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    def location_area_code(self):
        """Gets the location_area_code of this DeviceNetworks.  # noqa: E501

        The Location Area Code (LAC) is a16-bit identifier for a region that is covered by a set of network antennas.  # noqa: E501

        :return: The location_area_code of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def location_area_code(self, location_area_code):
        """Sets the location_area_code of this DeviceNetworks.

        The Location Area Code (LAC) is a16-bit identifier for a region that is covered by a set of network antennas.  # noqa: E501

        :param location_area_code: The location_area_code of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cell_id(self):
        """Gets the cell_id of this DeviceNetworks.  # noqa: E501
        ...
        :return: The cell_id of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def cell_id(self, cell_id):
        """Sets the cell_id of this DeviceNetworks.

        The Cell ID (CID) is identifier for a specific Base Transceiver Station (BTS) within a specific Location Area Code (LAC).  # noqa: E501

        :param cell_id: The cell_id of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def standard(self):
        """Gets the standard of this DeviceNetworks.  # noqa: E501

        An identifier of the network standard used.  # noqa: E501

        :return: The standard of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
    ...
    def standard(self, standard):
        """Sets the standard of this DeviceNetworks.

        An identifier of the network standard used.  # noqa: E501

        :param standard: The standard of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def mac(self):
        """Gets the mac of this DeviceNetworks.  # noqa: E501

        The MAC address of the device that is connected to the Wi-Fi network.  # noqa: E501

        :return: The mac of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
        return self._mac
    ...
    @mac.setter
    def mac(self, mac):
        """Sets the mac of this DeviceNetworks.

        The MAC address of the device that is connected to the Wi-Fi network.  # noqa: E501

        :param mac: The mac of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ssid(self):
        """Gets the ssid of this DeviceNetworks.  # noqa: E501

        The Wi-Fi networks Service Set Identifier (SSID).  # noqa: E501

        :return: The ssid of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
        return self._ssid
    ...
    @ssid.setter
    def ssid(self, ssid):
        """Sets the ssid of this DeviceNetworks.

        The Wi-Fi networks Service Set Identifier (SSID).  # noqa: E501

        :param ssid: The ssid of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def bssid(self):
        """Gets the bssid of this DeviceNetworks.  # noqa: E501

        The Wi-Fi networks Basic Service Set Identifier (BSSID).  # noqa: E501

        :return: The bssid of this DeviceNetworks.  # noqa: E501
        :rtype: str
        """
        return self._bssid
    ...
    def bssid(self, bssid):
        """Sets the bssid of this DeviceNetworks.

        The Wi-Fi networks Basic Service Set Identifier (BSSID).  # noqa: E501

        :param bssid: The bssid of this DeviceNetworks.  # noqa: E501
        :type: str
        """
    ...
    def user_defined(self):
        """Gets the user_defined of this DeviceNetworks.  # noqa: E501
        ...
        :return: The user_defined of this DeviceNetworks.  # noqa: E501
        :rtype: object
        """
    ...
    def user_defined(self, user_defined):
        """Sets the user_defined of this DeviceNetworks.

        A JSON object that can carry any additional information about the network that might be helpful for fraud detection.  # noqa: E501

        :param user_defined: The user_defined of this DeviceNetworks.  # noqa: E501
        :type: object
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceNetworks):
            return False
