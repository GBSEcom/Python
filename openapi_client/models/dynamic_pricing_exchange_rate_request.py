...
class DynamicPricingExchangeRateRequest(object):
    ...
    def __init__(self, request_type=None, base_amount=None, store_id=None, foreign_currency=None, local_vars_configuration=None):  # noqa: E501
    ...
    def foreign_currency(self, foreign_currency):
        ...
        if (self.local_vars_configuration.client_side_validation and
                foreign_currency is not None and len(foreign_currency) > 3):
