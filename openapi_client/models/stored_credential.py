...
class StoredCredential(object):
    ...
    def __init__(self, sequence=None, scheduled=None, referenced_scheme_transaction_id=None, initiator=None, local_vars_configuration=None):  # noqa: E501
    ...
    def sequence(self, sequence):
        ...
        if self.local_vars_configuration.client_side_validation and sequence not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def referenced_scheme_transaction_id(self, referenced_scheme_transaction_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                referenced_scheme_transaction_id is not None and len(referenced_scheme_transaction_id) > 50):
    ...
    def initiator(self, initiator):
        ...
        if self.local_vars_configuration.client_side_validation and initiator not in allowed_values:  # noqa: E501
            raise ValueError(
