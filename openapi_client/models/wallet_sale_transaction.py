...
class WalletSaleTransaction(object):
    ...
    def __init__(self, request_type=None, transaction_amount=None, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None, wallet_payment_method=None, payment_facilitator=None, local_vars_configuration=None):  # noqa: E501
