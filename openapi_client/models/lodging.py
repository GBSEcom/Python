...
class Lodging(object):
    ...
    def __init__(self, arrival_date=None, departure_date=None, folio_number=None, extra_charges=None, no_show_indicator=None, local_vars_configuration=None):  # noqa: E501
    ...
    def folio_number(self, folio_number):
        ...
        if (self.local_vars_configuration.client_side_validation and
                folio_number is not None and len(folio_number) > 20):
