...
class BancontactQR(object):
    ...
    def __init__(self, transaction_routing_means=None, issuer_customer_reference=None, local_vars_configuration=None):  # noqa: E501
    ...
    def transaction_routing_means(self, transaction_routing_means):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and transaction_routing_means is None:  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation and transaction_routing_means not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def issuer_customer_reference(self, issuer_customer_reference):
        ...
        if (self.local_vars_configuration.client_side_validation and
                issuer_customer_reference is not None and len(issuer_customer_reference) > 254):
