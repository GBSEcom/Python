...
class PaymentCardPaymentTokenizationRequest(object):
    ...
    def __init__(self, request_type=None, store_id=None, billing_address=None, create_token=None, account_verification=False, additional_details=None, payment_card=None, local_vars_configuration=None):  # noqa: E501
