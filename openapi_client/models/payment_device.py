...
class PaymentDevice(object):
    ...
    def __init__(self, device_type=None, data=None, security_code=None, cardholder_name=None, card_function=None, brand=None, local_vars_configuration=None):  # noqa: E501
