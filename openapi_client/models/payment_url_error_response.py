...
class PaymentUrlErrorResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, request_status=None, order_id=None, payment_url=None, transaction_id=None, error=None, local_vars_configuration=None):  # noqa: E501
