...
class ClientRegistration(object):
    ...
    def __init__(self, merchant_ref=None, transaction_type=None, customer=None, merchant=None, device=None, user_defined=None, original_transaction_type=None, local_vars_configuration=None):  # noqa: E501
