...
class PaymentRegistration(object):
    ...
    def __init__(self, merchant_ref=None, transaction_type=None, customer=None, merchant=None, device=None, user_defined=None, original_transaction_type=None, issuer_response=None, verification_avs=None, verification3ds=None, verification_cvv=None, registration_method=None, local_vars_configuration=None):  # noqa: E501
    ...
    def registration_method(self, registration_method):
        ...
        """
        if self.local_vars_configuration.client_side_validation and registration_method is None:  # noqa: E501
