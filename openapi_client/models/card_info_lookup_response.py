...
class CardInfoLookupResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, card_details=None, request_status=None, local_vars_configuration=None):  # noqa: E501
