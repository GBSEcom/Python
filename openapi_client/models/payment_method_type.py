...
class PaymentMethodType(object):
    ...
    allowable_values = [ALIPAY, ALIPAY_PAYSECURE_US, ALIPAY_DOMESTIC, APM, CUP_DOMESTIC, DEBITDE, EMI, GIROPAY, IDEAL, INDIAWALLET, KLARNA, KPS, NETBANKING, PAYMENT_CARD, PAYMENT_TOKEN, PAYPAL, SEPA, SOFORT, WALLET, WECHAT_DOMESTIC, TELECHECK]  # noqa: E501
