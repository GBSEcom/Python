...
class OrderResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, order_id=None, billing=None, shipping=None, transactions=None, additional_details=None, local_vars_configuration=None):  # noqa: E501
