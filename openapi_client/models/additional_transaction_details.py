...
class AdditionalTransactionDetails(object):
    ...
    def __init__(self, comments=None, invoice_number=None, purchase_order_number=None, disbursement_trans_type=None, wallet_provider=None, local_vars_configuration=None):  # noqa: E501
    ...
    def disbursement_trans_type(self, disbursement_trans_type):
        ...
        if self.local_vars_configuration.client_side_validation and disbursement_trans_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def wallet_provider(self, wallet_provider):
        ...
        if self.local_vars_configuration.client_side_validation and wallet_provider not in allowed_values:  # noqa: E501
            raise ValueError(
