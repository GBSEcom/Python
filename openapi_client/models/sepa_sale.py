...
class SepaSale(object):
    ...
    def __init__(self, iban=None, name=None, country=None, email=None, mandate=None):  # noqa: E501
        """SepaSale - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def iban(self):
        """Gets the iban of this SepaSale.  # noqa: E501

        Bank account in IBAN format.  # noqa: E501

        :return: The iban of this SepaSale.  # noqa: E501
        :rtype: str
        """
        return self._iban
    ...
    @iban.setter
    def iban(self, iban):
        """Sets the iban of this SepaSale.

        Bank account in IBAN format.  # noqa: E501

        :param iban: The iban of this SepaSale.  # noqa: E501
        :type: str
        """
        if iban is None:
    ...
    @property
    def name(self):
        """Gets the name of this SepaSale.  # noqa: E501

        The name of the payer.  # noqa: E501

        :return: The name of this SepaSale.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SepaSale.

        The name of the payer.  # noqa: E501

        :param name: The name of this SepaSale.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def country(self):
        """Gets the country of this SepaSale.  # noqa: E501

        Country of residence of the payer using the ISO 3166 standard.  # noqa: E501

        :return: The country of this SepaSale.  # noqa: E501
        :rtype: str
        """
    ...
    def country(self, country):
        """Sets the country of this SepaSale.

        Country of residence of the payer using the ISO 3166 standard.  # noqa: E501

        :param country: The country of this SepaSale.  # noqa: E501
        :type: str
        """
        if country is None:
    ...
    @property
    def email(self):
        """Gets the email of this SepaSale.  # noqa: E501

        The email address of the payer.  # noqa: E501

        :return: The email of this SepaSale.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this SepaSale.

        The email address of the payer.  # noqa: E501

        :param email: The email of this SepaSale.  # noqa: E501
        :type: str
        """
    ...
    @property
    def mandate(self):
        """Gets the mandate of this SepaSale.  # noqa: E501


        :return: The mandate of this SepaSale.  # noqa: E501
        :rtype: SepaMandate
        """
    ...
    def mandate(self, mandate):
        """Sets the mandate of this SepaSale.


        :param mandate: The mandate of this SepaSale.  # noqa: E501
        :type: SepaMandate
        """
        if mandate is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SepaSale):
            return False
