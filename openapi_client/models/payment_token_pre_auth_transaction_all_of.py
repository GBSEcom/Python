...
class PaymentTokenPreAuthTransactionAllOf(object):
    ...
    def __init__(self, request_type=None, transaction_amount=None, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None, payment_method=None, stored_credentials=None, split_shipment=None, settlement_split=None):  # noqa: E501
