...
class Customer(object):
    ...
    def __init__(self, id=None, start_date=None, first_name=None, last_name=None, middle_name=None, email=None, session_id=None, username=None, gender=None, date_of_birth=None, address=None, user_defined=None, local_vars_configuration=None):  # noqa: E501
