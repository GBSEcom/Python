...
class PayPal(object):
    ...
    def __init__(self, recipient_email=None, local_vars_configuration=None):  # noqa: E501
    ...
    def recipient_email(self, recipient_email):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and recipient_email is None:  # noqa: E501
        ...
        if (self.local_vars_configuration.client_side_validation and
                recipient_email is not None and not re.search(r'^(?!\s*$).+', recipient_email)):  # noqa: E501
