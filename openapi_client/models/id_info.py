...
class IdInfo(object):
    ...
    def __init__(self, id_type=None, id_data=None, local_vars_configuration=None):  # noqa: E501
    ...
    def id_type(self, id_type):
        ...
        if (self.local_vars_configuration.client_side_validation and
                id_type is not None and len(id_type) > 2):
