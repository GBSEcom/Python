...
class OrderErrorResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, order_id=None, transaction_time=None, billing=None, shipping=None, mandate=None, transactions=None, processor=None, error=None):  # noqa: E501
