...
class SharedSecretConfigurationRequest(object):
    ...
    def __init__(self, shared_secret=None, local_vars_configuration=None):  # noqa: E501
    ...
    def shared_secret(self, shared_secret):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and shared_secret is None:  # noqa: E501
            raise ValueError("Invalid value for `shared_secret`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                shared_secret is not None and not re.search(r'[^ ]{7,16}', shared_secret)):  # noqa: E501
