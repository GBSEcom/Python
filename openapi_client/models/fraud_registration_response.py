...
class FraudRegistrationResponse(object):
    ...
    def __init__(self, correlation_id=None, transaction_status=None, validation_status=None, transaction_type=None, fraud_score=None, error=None, local_vars_configuration=None):  # noqa: E501
