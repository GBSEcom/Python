...
class Secure3D10AuthenticationResult(object):
    ...
    def __init__(self, authentication_type=None, verification_response=None, authentication_attempt_result=None, cavv=None, xid=None, local_vars_configuration=None):  # noqa: E501
