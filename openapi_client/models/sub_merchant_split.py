...
class SubMerchantSplit(object):
    ...
    def __init__(self, merchant_id=None, amount=None, local_vars_configuration=None):  # noqa: E501
    ...
    def merchant_id(self, merchant_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                merchant_id is not None and len(merchant_id) > 15):
            raise ValueError("Invalid value for `merchant_id`, length must be less than or equal to `15`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                merchant_id is not None and not re.search(r'[0-9]{1,15}', merchant_id)):  # noqa: E501
