...
class SubMerchantSplit(object):
    ...
    def merchant_id(self, merchant_id):
        ...
        if merchant_id is not None and not re.search(r'[0-9]{0,15}', merchant_id):  # noqa: E501
            raise ValueError(r"Invalid value for `merchant_id`, must be a follow pattern or equal to `/[0-9]{0,15}/`")  # noqa: E501
