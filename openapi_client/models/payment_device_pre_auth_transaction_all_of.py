...
class PaymentDevicePreAuthTransactionAllOf(object):
    ...
    def __init__(self, payment_method=None, create_token=None, settlement_split=None, stored_credentials=None, split_shipment=None, decremental_flag=False):  # noqa: E501
