...
class WalletPreAuthTransaction(object):
    ...
    def __init__(self, request_type=None, transaction_amount=None, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None, allow_partial_approval=None, wallet_payment_method=None, split_shipment=None, payment_facilitator=None, decremental_flag=False):  # noqa: E501
