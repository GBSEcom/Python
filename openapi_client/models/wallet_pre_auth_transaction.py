...
class WalletPreAuthTransaction(object):
    ...
    def __init__(self, request_type=None, transaction_amount=None, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None, wallet_payment_method=None, split_shipment=None, payment_facilitator=None, decremental_flag=False, local_vars_configuration=None):  # noqa: E501
