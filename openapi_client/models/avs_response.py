...
class AVSResponse(object):
    ...
    def __init__(self, street_match=None, postal_code_match=None, association_avs_response=None, local_vars_configuration=None):  # noqa: E501
    ...
    def street_match(self, street_match):
        ...
        if self.local_vars_configuration.client_side_validation and street_match not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def postal_code_match(self, postal_code_match):
        ...
        """
        allowed_values = ["Y", "N", "NO_INPUT_DATA", "NOT_CHECKED"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and postal_code_match not in allowed_values:  # noqa: E501
            raise ValueError(
