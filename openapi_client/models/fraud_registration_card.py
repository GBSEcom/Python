...
class FraudRegistrationCard(object):
    ...
    def __init__(self, cardholder_name=None, card_number=None, exp_date=None, cvv_present=None, issuer=None, card_reissued_number=None, local_vars_configuration=None):  # noqa: E501
