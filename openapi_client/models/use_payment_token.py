...
class UsePaymentToken(object):
    ...
    def __init__(self, value=None, token_origin_store_id=None, function=None, security_code=None, expiry_date=None, local_vars_configuration=None):  # noqa: E501
    ...
    def token_origin_store_id(self, token_origin_store_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                token_origin_store_id is not None and len(token_origin_store_id) > 20):
