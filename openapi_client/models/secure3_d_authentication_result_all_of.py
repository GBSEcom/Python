...
class Secure3DAuthenticationResultAllOf(object):
    ...
    def __init__(self, cavv=None, xid=None, ds_transaction_id=None, authentication_response=None, transaction_status=None, message_category=None):  # noqa: E501
        """Secure3DAuthenticationResultAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def cavv(self):
        """Gets the cavv of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        ...
        :return: The cavv of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :rtype: str
        """
        return self._cavv
    ...
    @cavv.setter
    def cavv(self, cavv):
        """Sets the cavv of this Secure3DAuthenticationResultAllOf.

        The Cardholder Authentication Verification Value (CAVV) is a cryptographic value derived by the issuer during payment authentication that can provide evidence of the results of payment authentication during an online purchase.  # noqa: E501

        :param cavv: The cavv of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def xid(self):
        """Gets the xid of this Secure3DAuthenticationResultAllOf.  # noqa: E501

        The transaction identifier (XID) is a unique tracking number set by the merchant.  # noqa: E501

        :return: The xid of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :rtype: str
        """
        return self._xid
    ...
    @xid.setter
    def xid(self, xid):
        """Sets the xid of this Secure3DAuthenticationResultAllOf.

        The transaction identifier (XID) is a unique tracking number set by the merchant.  # noqa: E501

        :param xid: The xid of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :type: str
        """
    ...
    def ds_transaction_id(self):
        """Gets the ds_transaction_id of this Secure3DAuthenticationResultAllOf.  # noqa: E501

        The response transaction UUID from the DS (directory server)  # noqa: E501

        :return: The ds_transaction_id of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def ds_transaction_id(self, ds_transaction_id):
        """Sets the ds_transaction_id of this Secure3DAuthenticationResultAllOf.

        The response transaction UUID from the DS (directory server)  # noqa: E501

        :param ds_transaction_id: The ds_transaction_id of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :type: str
        """
    ...
    def authentication_response(self):
        """Gets the authentication_response of this Secure3DAuthenticationResultAllOf.  # noqa: E501

        The result of authentication attempt returned by the 3D Secure authentication process (ARes).  # noqa: E501

        :return: The authentication_response of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def authentication_response(self, authentication_response):
        """Sets the authentication_response of this Secure3DAuthenticationResultAllOf.

        The result of authentication attempt returned by the 3D Secure authentication process (ARes).  # noqa: E501

        :param authentication_response: The authentication_response of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :type: str
        """
    ...
    def transaction_status(self):
        """Gets the transaction_status of this Secure3DAuthenticationResultAllOf.  # noqa: E501

        The transaction status as returned by the 3D Secure authentication process. (CRes)  # noqa: E501

        :return: The transaction_status of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_status(self, transaction_status):
        """Sets the transaction_status of this Secure3DAuthenticationResultAllOf.

        The transaction status as returned by the 3D Secure authentication process. (CRes)  # noqa: E501

        :param transaction_status: The transaction_status of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :type: str
        """
        allowed_values = ["A", "N", "U", "Y", "C", "R"]  # noqa: E501
    ...
    def message_category(self):
        """Gets the message_category of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        ...
        :return: The message_category of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def message_category(self, message_category):
        """Sets the message_category of this Secure3DAuthenticationResultAllOf.

        Indicates the message category of 3d secure authentication version 2.X. 01 = Payment Authentication 02 = Non-Payment Authentication 80 = Mastercard Data Only   # noqa: E501

        :param message_category: The message_category of this Secure3DAuthenticationResultAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Secure3DAuthenticationResultAllOf):
            return False
