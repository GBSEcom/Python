...
class PaymentDevicePaymentTokenizationRequest(object):
    ...
    def __init__(self, request_type=None, store_id=None, billing_address=None, create_token=None, account_verification=False, merchant_transaction_id=None, additional_details=None, payment_device=None):  # noqa: E501
