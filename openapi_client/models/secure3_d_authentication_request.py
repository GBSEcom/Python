...
class Secure3DAuthenticationRequest(object):
    ...
    def __init__(self, authentication_type=None, term_url=None, method_notification_url=None, challenge_indicator='01', message_category=None, challenge_window_size=None):  # noqa: E501
