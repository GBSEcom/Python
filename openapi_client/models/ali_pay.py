...
class AliPay(object):
    ...
    def __init__(self, payment_data_type=None, payment_data=None, order_title=None, order_details=None, local_vars_configuration=None):  # noqa: E501
    ...
    def payment_data_type(self, payment_data_type):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and payment_data_type is None:  # noqa: E501
            raise ValueError("Invalid value for `payment_data_type`, must not be `None`")  # noqa: E501
        allowed_values = ["BARCODE", "QRCODE"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and payment_data_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def payment_data(self, payment_data):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and payment_data is None:  # noqa: E501
            raise ValueError("Invalid value for `payment_data`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                payment_data is not None and len(payment_data) > 100):
            raise ValueError("Invalid value for `payment_data`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                payment_data is not None and not re.search(r'^(?!\s*$).+', payment_data)):  # noqa: E501
    ...
    def order_title(self, order_title):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and order_title is None:  # noqa: E501
            raise ValueError("Invalid value for `order_title`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                order_title is not None and len(order_title) > 100):
            raise ValueError("Invalid value for `order_title`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                order_title is not None and not re.search(r'^(?!\s*$).+', order_title)):  # noqa: E501
    ...
    def order_details(self, order_details):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and order_details is None:  # noqa: E501
            raise ValueError("Invalid value for `order_details`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                order_details is not None and len(order_details) > 1024):
            raise ValueError("Invalid value for `order_details`, length must be less than or equal to `1024`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                order_details is not None and not re.search(r'^(?!\s*$).+', order_details)):  # noqa: E501
