...
class SplitShipment(object):
    ...
    attribute_map = {
        ...
        'final_shipment': 'finalShipment',  # noqa: E501
    }

    def __init__(self, total_count=None, final_shipment=None):  # noqa: E501
        """SplitShipment - a model defined in OpenAPI



        Keyword Args:
            total_count (int): Total count of the shipment, can be set at preauth or the first postauth.. [optional]  # noqa: E501
            final_shipment (bool): Indicates whether the transaction is the final shipment.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
        ...
        if total_count is not None:
            self.total_count = total_count  # noqa: E501
        if final_shipment is not None:
            self.final_shipment = final_shipment  # noqa: E501
