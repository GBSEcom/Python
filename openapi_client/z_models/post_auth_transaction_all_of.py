...
class PostAuthTransactionAllOf(object):
    ...
    def __init__(self, transaction_amount, transaction_origin=None, split_shipment=None, soft_descriptor=None):  # noqa: E501
        """PostAuthTransactionAllOf - a model defined in OpenAPI
