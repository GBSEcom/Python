...
class AliPay(object):
    ...
    attribute_map = {
        'payment_data_type': 'paymentDataType',  # noqa: E501
        'payment_data': 'paymentData',  # noqa: E501
        'order_title': 'orderTitle',  # noqa: E501
        'order_details': 'orderDetails',  # noqa: E501
    }

    def __init__(self, payment_data_type, payment_data, order_title, order_details):  # noqa: E501
        """AliPay - a model defined in OpenAPI
