...
class Customer(object):
    ...
    def __init__(self, id, start_date=None, first_name=None, last_name=None, middle_name=None, email=None, session_id=None, username=None, gender=None, date_of_birth=None, address=None, user_defined=None):  # noqa: E501
        ...
        Keyword Args:  # noqa: E501
            start_date (str): The timestamp of the customers registration in the merchants platform. Format is YYYY-MM-DD.. [optional]  # noqa: E501
            ...
            session_id (str): The unique ID of the current login session. Must be unique for the customer.. [optional]  # noqa: E501
            username (str): The username of this customer in the merchants system. This field should contain customer-supplied data if available instead of a generated ID. This field can contain the clients email address if it is also used for authentication purposes.. [optional]  # noqa: E501
            gender (str): The customers gender. Do not set this property if the customer does not specify a gender.. [optional]  # noqa: E501
            date_of_birth (str): The customer&#39;s year of birth. Format is YYYY.. [optional]  # noqa: E501
            address (CustomerAddress): [optional]  # noqa: E501
            user_defined (object): A JSON object that can carry any additional information about the customer that might be helpful for fraud detection.. [optional]  # noqa: E501
        """
        ...
        if middle_name is not None:
            self.middle_name = middle_name  # noqa: E501
        if email is not None:
            self.email = email  # noqa: E501
        if session_id is not None:
            self.session_id = session_id  # noqa: E501
        if username is not None:
            self.username = username  # noqa: E501
        if gender is not None:
            self.gender = gender  # noqa: E501
        if date_of_birth is not None:
            self.date_of_birth = date_of_birth  # noqa: E501
