...
class InstallmentOptions(object):
    ...
    attribute_map = {
        'number_of_installments': 'numberOfInstallments',  # noqa: E501
        'installments_interest': 'installmentsInterest',  # noqa: E501
        'installment_delay_months': 'installmentDelayMonths',  # noqa: E501
        'recurring_type': 'recurringType',  # noqa: E501
        'merchant_advice_code_supported': 'merchantAdviceCodeSupported',  # noqa: E501
    }
    ...
    def __init__(self, number_of_installments=None, installments_interest=None, installment_delay_months=None, recurring_type=None, merchant_advice_code_supported=None):  # noqa: E501
        ...
        Keyword Args:
            number_of_installments (int): Number of installments for a sale transaction if the customer pays the total amount in multiple transactions.. [optional]  # noqa: E501
            installments_interest (bool): Indicates whether the installment interest amount has been applied.. [optional]  # noqa: E501
            installment_delay_months (int): The number of months the first installment payment will be delayed.. [optional]  # noqa: E501
            recurring_type (str): The type of recurring payment.. [optional]  # noqa: E501
            merchant_advice_code_supported (bool): Indicates if the merchant supports merchant advice code (MAC) in order to receive table 55 code for a declined recurring transaction.. [optional]  # noqa: E501
        """
        ...
        if number_of_installments is not None:
            self.number_of_installments = number_of_installments  # noqa: E501
        if installments_interest is not None:
            self.installments_interest = installments_interest  # noqa: E501
        if installment_delay_months is not None:
            self.installment_delay_months = installment_delay_months  # noqa: E501
        if recurring_type is not None:
            self.recurring_type = recurring_type  # noqa: E501
        if merchant_advice_code_supported is not None:
            self.merchant_advice_code_supported = merchant_advice_code_supported  # noqa: E501
    ...
    def installment_delay_months(
        ...
        self._installment_delay_months = (
            installment_delay_months)
    ...
    def merchant_advice_code_supported(
        ...
        self._merchant_advice_code_supported = (
            merchant_advice_code_supported)
