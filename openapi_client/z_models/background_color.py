...
class BackgroundColor(object):
    ...
    def __init__(self, header=None, content=None, footer=None):  # noqa: E501
        """BackgroundColor - a model defined in OpenAPI



        Keyword Args:
            header (Header): [optional]  # noqa: E501
            content (Content): [optional]  # noqa: E501
            footer (Footer): [optional]  # noqa: E501
        """
        ...
        if header is not None:
            self.header = header  # noqa: E501
        if content is not None:
            self.content = content  # noqa: E501
        if footer is not None:
            self.footer = footer  # noqa: E501
