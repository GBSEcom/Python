...
class AdditionalDetails(object):
    ...
    attribute_map = {
        ...
        'sales_system_id': 'salesSystemId',  # noqa: E501
        'ipg_deferred_auth': 'ipgDeferredAuth',  # noqa: E501
        'high_risk_purchase_indicator': 'highRiskPurchaseIndicator',  # noqa: E501
        'receipts': 'receipts',  # noqa: E501
        'sca_exemption_type': 'scaExemptionType',  # noqa: E501
        'sca_visa_merchant_id': 'scaVisaMerchantID',  # noqa: E501
    }
    ...
    def __init__(self, comments=None, invoice_number=None, purchase_order_number=None, operator_id=None, sales_system_id=None, ipg_deferred_auth=None, high_risk_purchase_indicator=None, receipts=None, sca_exemption_type=None, sca_visa_merchant_id=None):  # noqa: E501
        """AdditionalDetails - a model defined in OpenAPI



        Keyword Args:
            comments (str): Comments for the payment.. [optional]  # noqa: E501
            invoice_number (str): Invoice number.. [optional]  # noqa: E501
            purchase_order_number (str): Purchase order number.. [optional]  # noqa: E501
            operator_id (str): The operator ID.. [optional]  # noqa: E501
            sales_system_id (str): The sales system ID.. [optional]  # noqa: E501
            ipg_deferred_auth (bool): Indicates if the particular transaction is a deferred authorization.. [optional]  # noqa: E501
            high_risk_purchase_indicator (bool): this is highRiskPurchaseIndicator.. [optional]  # noqa: E501
            receipts (list[ReceiptRequestInfo]): Provides request information that is necessary to generate receipts.. [optional]  # noqa: E501
            sca_exemption_type (str): Strong customer authentication exemption type indicator.. [optional]  # noqa: E501
            sca_visa_merchant_id (str): Eight-character Visa merchant identifier (VMID) assigned by Visa, required for trusted merchant and delegated authentication.. [optional]  # noqa: E501
        """
        ...
        if operator_id is not None:
            self.operator_id = operator_id  # noqa: E501
        if sales_system_id is not None:
            self.sales_system_id = sales_system_id  # noqa: E501
        if ipg_deferred_auth is not None:
            self.ipg_deferred_auth = ipg_deferred_auth  # noqa: E501
        if high_risk_purchase_indicator is not None:
            self.high_risk_purchase_indicator = high_risk_purchase_indicator  # noqa: E501
        if receipts is not None:
            self.receipts = receipts  # noqa: E501
        if sca_exemption_type is not None:
            self.sca_exemption_type = sca_exemption_type  # noqa: E501
        if sca_visa_merchant_id is not None:
            self.sca_visa_merchant_id = sca_visa_merchant_id  # noqa: E501
    ...
    def high_risk_purchase_indicator(
            self,
        ...
        self._high_risk_purchase_indicator = (
            high_risk_purchase_indicator)
