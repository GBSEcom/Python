...
class ResponseAmountComponents(object):
    ...
    attribute_map = {
        ...
        'tip': 'tip',  # noqa: E501
        'convenience_fee': 'convenienceFee',  # noqa: E501
    }
    ...
    def __init__(self, subtotal=None, vat_amount=None, local_tax=None, shipping=None, cashback=None, tip=None, convenience_fee=None):  # noqa: E501
        """ResponseAmountComponents - a model defined in OpenAPI



        Keyword Args:
            subtotal (float): Subtotal amount.. [optional]  # noqa: E501
            vat_amount (float): Value-added tax amount.. [optional]  # noqa: E501
            local_tax (float): Local tax amount.. [optional]  # noqa: E501
            shipping (float): Shipping amount.. [optional]  # noqa: E501
            cashback (float): Cashback amount.. [optional]  # noqa: E501
            tip (float): Tip amount.. [optional]  # noqa: E501
            convenience_fee (float): Amount added for proccessing or handling fees.. [optional]  # noqa: E501
        """
        ...
        if subtotal is not None:
            self.subtotal = subtotal  # noqa: E501
        if vat_amount is not None:
            self.vat_amount = vat_amount  # noqa: E501
        if local_tax is not None:
            self.local_tax = local_tax  # noqa: E501
        if shipping is not None:
            self.shipping = shipping  # noqa: E501
        if cashback is not None:
            self.cashback = cashback  # noqa: E501
        if tip is not None:
            self.tip = tip  # noqa: E501
        if convenience_fee is not None:
            self.convenience_fee = convenience_fee  # noqa: E501
