...
class ClearingElement(object):
    ...
    def __init__(self, brand=None, value=None, count=None):  # noqa: E501
        """ClearingElement - a model defined in OpenAPI



        Keyword Args:
            brand (str): Contains the brand of the card.. [optional]  # noqa: E501
            value (int): Holds the total clearing value computed for a specific brand.. [optional]  # noqa: E501
            count (int): Specifies the amount of clearing elements for a given brand.. [optional]  # noqa: E501
        """
