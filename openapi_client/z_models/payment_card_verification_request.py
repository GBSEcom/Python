...
class PaymentCardVerificationRequest(object):
    ...
    def __init__(self, request_type, payment_card, billing_address=None, store_id=None, merchant_transaction_id=None, additional_details=None):  # noqa: E501
        """PaymentCardVerificationRequest - a model defined in OpenAPI
