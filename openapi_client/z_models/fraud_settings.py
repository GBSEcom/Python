...
class FraudSettings(object):
    ...
    attribute_map = {
        'blocked_items': 'blockedItems',  # noqa: E501
    ...
    def __init__(self, blocked_items=None, maximum_purchase_amount=None, lockout_time=None, country_profile=None):  # noqa: E501
        """FraudSettings - a model defined in OpenAPI



        Keyword Args:
            blocked_items (BlockedItems): [optional]  # noqa: E501
            maximum_purchase_amount (list[MaximumPurchaseAmount]): [optional]  # noqa: E501
            lockout_time (LockoutTime): [optional]  # noqa: E501
            country_profile (CountryProfile): [optional]  # noqa: E501
        """
        ...
        if blocked_items is not None:
            self.blocked_items = blocked_items  # noqa: E501
