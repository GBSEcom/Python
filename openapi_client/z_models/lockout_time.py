...
class LockoutTime(object):
    ...
    attribute_map = {
        'auto_lockout_time': 'autoLockoutTime',  # noqa: E501
        'duplicate_lockout_time': 'duplicateLockoutTime',  # noqa: E501
    }

    def __init__(self, auto_lockout_time=None, duplicate_lockout_time=None):  # noqa: E501
        """LockoutTime - a model defined in OpenAPI



        Keyword Args:
            auto_lockout_time (int): Auto-lockout time.. [optional]  # noqa: E501
            duplicate_lockout_time (int): Duplicate lockout time.. [optional]  # noqa: E501
        """
        ...
        if auto_lockout_time is not None:
            self.auto_lockout_time = auto_lockout_time  # noqa: E501
        if duplicate_lockout_time is not None:
            self.duplicate_lockout_time = duplicate_lockout_time  # noqa: E501
    ...
    def duplicate_lockout_time(
            self,
            duplicate_lockout_time):
