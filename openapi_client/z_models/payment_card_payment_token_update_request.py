...
class PaymentCardPaymentTokenUpdateRequest(object):
    ...
    attribute_map = {
        ...
        'payment_tokens': 'paymentTokens',  # noqa: E501
        'store_id': 'storeId',  # noqa: E501
    }

    def __init__(self, request_type, payment_tokens, store_id=None):  # noqa: E501
        """PaymentCardPaymentTokenUpdateRequest - a model defined in OpenAPI

        Args:
            request_type (str): Object name of tokenization request.
            payment_tokens (list[UpdatePaymentToken]): List of payment tokens to be updated in the request.
