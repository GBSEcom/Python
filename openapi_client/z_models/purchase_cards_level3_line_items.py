...
class PurchaseCardsLevel3LineItems(object):
    ...
    attribute_map = {
        'commodity_code': 'commodityCode',  # noqa: E501
        'product_code': 'productCode',  # noqa: E501
        'description': 'description',  # noqa: E501
        'quantity': 'quantity',  # noqa: E501
        'unit_measure': 'unitMeasure',  # noqa: E501
        'unit_price': 'unitPrice',  # noqa: E501
        'vat_amount_and_rate': 'vatAmountAndRate',  # noqa: E501
        'discount_amount_and_rate': 'discountAmountAndRate',  # noqa: E501
        'line_item_total': 'lineItemTotal',  # noqa: E501
    }
    ...
    def __init__(self, commodity_code=None, product_code=None, description=None, quantity=None, unit_measure=None, unit_price=None, vat_amount_and_rate=None, discount_amount_and_rate=None, line_item_total=None):  # noqa: E501
        """PurchaseCardsLevel3LineItems - a model defined in OpenAPI



        Keyword Args:
            commodity_code (str): The commodity code used to classify the item purchased.. [optional]  # noqa: E501
            product_code (str): Merchant product identifier/the Universal Product Code (UPC) of the item purchased.. [optional]  # noqa: E501
            description (str): The description.. [optional]  # noqa: E501
            quantity (int): The quantity.. [optional]  # noqa: E501
            unit_measure (str): The unit of measure.. [optional]  # noqa: E501
            unit_price (float): Rate amount in 3 decimal 12 bytes total digit.. [optional]  # noqa: E501
            vat_amount_and_rate (AdditionalAmountRate): [optional]  # noqa: E501
            discount_amount_and_rate (AdditionalAmountRate): [optional]  # noqa: E501
            line_item_total (float): Rate amount in 3 decimal 12 bytes total digit.. [optional]  # noqa: E501
        """
        ...
        if commodity_code is not None:
            self.commodity_code = commodity_code  # noqa: E501
        if product_code is not None:
            self.product_code = product_code  # noqa: E501
        if description is not None:
            self.description = description  # noqa: E501
        if quantity is not None:
            self.quantity = quantity  # noqa: E501
        if unit_measure is not None:
            self.unit_measure = unit_measure  # noqa: E501
        if unit_price is not None:
            self.unit_price = unit_price  # noqa: E501
        if vat_amount_and_rate is not None:
            self.vat_amount_and_rate = vat_amount_and_rate  # noqa: E501
        if discount_amount_and_rate is not None:
            self.discount_amount_and_rate = discount_amount_and_rate  # noqa: E501
        if line_item_total is not None:
            self.line_item_total = line_item_total  # noqa: E501
    ...
    def discount_amount_and_rate(
        ...
        self._discount_amount_and_rate = (
            discount_amount_and_rate)
