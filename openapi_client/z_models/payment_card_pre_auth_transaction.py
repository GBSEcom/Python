...
class PaymentCardPreAuthTransaction(object):
    ...
    def __init__(self, request_type, transaction_amount, payment_method, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None, stored_credentials=None, create_token=None, split_shipment=None, settlement_split=None, authentication_request=None, authentication_result=None, decremental_flag=None):  # noqa: E501
        """PaymentCardPreAuthTransaction - a model defined in OpenAPI
