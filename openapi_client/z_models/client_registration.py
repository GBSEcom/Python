...
class ClientRegistration(object):
    ...
    def __init__(self, transaction_type, customer, merchant, original_transaction_type, merchant_ref=None, device=None, user_defined=None):  # noqa: E501
        """ClientRegistration - a model defined in OpenAPI
