...
class Secure3DAuthenticationResponseParams(object):
    ...
    attribute_map = {
        'payer_authentication_request': 'payerAuthenticationRequest',  # noqa: E501
        'term_url': 'termURL',  # noqa: E501
        'merchant_data': 'merchantData',  # noqa: E501
        'acs_url': 'acsURL',  # noqa: E501
        'c_req': 'cReq',  # noqa: E501
        'session_data': 'sessionData',  # noqa: E501
    }
    ...
    def __init__(self, payer_authentication_request=None, term_url=None, merchant_data=None, acs_url=None, c_req=None, session_data=None):  # noqa: E501
        """Secure3DAuthenticationResponseParams - a model defined in OpenAPI



        Keyword Args:
            payer_authentication_request (str): Message sent from merchant server to authenticate the cardholder.. [optional]  # noqa: E501
            term_url (str): Terminal URL for processing request.. [optional]  # noqa: E501
            merchant_data (str): Formatted string encoding transaction time, order ID, and return URL data.. [optional]  # noqa: E501
            acs_url (str): The URL for the authentication redirect for the merchant.. [optional]  # noqa: E501
            c_req (str): The CReq message initiates cardholder interaction in a 3DS 2.x challenge flow and carries authentication data from the cardholder.. [optional]  # noqa: E501
            session_data (str): Customer web browser session data.. [optional]  # noqa: E501
        """
        ...
        if payer_authentication_request is not None:
            self.payer_authentication_request = payer_authentication_request  # noqa: E501
        if term_url is not None:
            self.term_url = term_url  # noqa: E501
        if merchant_data is not None:
            self.merchant_data = merchant_data  # noqa: E501
        if acs_url is not None:
            self.acs_url = acs_url  # noqa: E501
        if c_req is not None:
            self.c_req = c_req  # noqa: E501
        if session_data is not None:
            self.session_data = session_data  # noqa: E501
    ...
    def payer_authentication_request(
            self,
            payer_authentication_request):
        ...
        self._payer_authentication_request = (
            payer_authentication_request)
