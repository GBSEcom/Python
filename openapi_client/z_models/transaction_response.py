...
class TransactionResponse(object):
    ...
    attribute_map = {
        ...
        'payment_method_details': 'paymentMethodDetails',  # noqa: E501
        ...
        'transaction_time': 'transactionTime',  # noqa: E501
        'approved_amount': 'approvedAmount',  # noqa: E501
        'transaction_status': 'transactionStatus',  # noqa: E501
        'transaction_state': 'transactionState',  # noqa: E501
        'secure3d_response': 'secure3dResponse',  # noqa: E501
        'redirect_url': 'redirectURL',  # noqa: E501
        'authentication_response': 'authenticationResponse',  # noqa: E501
        'scheme_transaction_id': 'schemeTransactionId',  # noqa: E501
        'processor': 'processor',  # noqa: E501
        'additional_details': 'additionalDetails',  # noqa: E501
        'account_updater_response': 'accountUpdaterResponse',  # noqa: E501
        'ach_response': 'achResponse',  # noqa: E501
        'currency_conversion_response': 'currencyConversionResponse',  # noqa: E501
    }
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, ipg_transaction_id=None, order_id=None, transaction_type=None, payment_token=None, transaction_origin=None, payment_method_details=None, country=None, terminal_id=None, merchant_id=None, merchant_transaction_id=None, transaction_time=None, approved_amount=None, transaction_status=None, transaction_state=None, secure3d_response=None, redirect_url=None, authentication_response=None, scheme_transaction_id=None, processor=None, additional_details=None, account_updater_response=None, ach_response=None, currency_conversion_response=None):  # noqa: E501
        ...
        Keyword Args:
            ...
            payment_method_details (PaymentMethodDetails): [optional]  # noqa: E501
            country (str): Country of the card issuer.. [optional]  # noqa: E501
            terminal_id (str): The terminal that is processing the transaction.. [optional]  # noqa: E501
            merchant_id (str): The unique (on Acquirer level) mechant ID. Usually this value has been chosen from the merchant itself and will be used in communication with the endpoint.. [optional]  # noqa: E501
            merchant_transaction_id (str): The unique merchant transaction ID from the request header, if supplied.. [optional]  # noqa: E501
            transaction_time (int): The transaction time in seconds since epoch.. [optional]  # noqa: E501
            approved_amount (Amount): [optional]  # noqa: E501
            transaction_status (str): Represents the status of a transaction immediately following the original processing request. This value is not stored for the transaction and is only available in the response when the transaction is processed. TransactionStatus is not returned on either the transaction inquiry or on the order inquiry.. [optional]  # noqa: E501
            transaction_state (str): Shows the state of the current transaction.. [optional]  # noqa: E501
            secure3d_response (Secure3dResponse): [optional]  # noqa: E501
            redirect_url (str): The endpoint redirection URL.. [optional]  # noqa: E501
            authentication_response (Secure3DAuthenticationResponse): [optional]  # noqa: E501
            scheme_transaction_id (str): The transaction ID received from schemes for the initial transaction of card on file flows.. [optional]  # noqa: E501
            processor (ProcessorData): [optional]  # noqa: E501
            additional_details (AdditionalTransactionDetails): [optional]  # noqa: E501
            account_updater_response (AccountUpdaterResponse): [optional]  # noqa: E501
            ach_response (AchResponse): [optional]  # noqa: E501
            currency_conversion_response (CurrencyConversionResponse): [optional]  # noqa: E501
        """
        ...
        if transaction_type is not None:
            self.transaction_type = transaction_type  # noqa: E501
        ...
        if payment_method_details is not None:
            self.payment_method_details = payment_method_details  # noqa: E501
        ...
        if transaction_time is not None:
            self.transaction_time = transaction_time  # noqa: E501
        if approved_amount is not None:
            self.approved_amount = approved_amount  # noqa: E501
        if transaction_status is not None:
            self.transaction_status = transaction_status  # noqa: E501
        if transaction_state is not None:
            self.transaction_state = transaction_state  # noqa: E501
        if secure3d_response is not None:
            self.secure3d_response = secure3d_response  # noqa: E501
        if redirect_url is not None:
            self.redirect_url = redirect_url  # noqa: E501
        if authentication_response is not None:
            self.authentication_response = authentication_response  # noqa: E501
        if scheme_transaction_id is not None:
            self.scheme_transaction_id = scheme_transaction_id  # noqa: E501
        ...
        if account_updater_response is not None:
            self.account_updater_response = account_updater_response  # noqa: E501
        if ach_response is not None:
            self.ach_response = ach_response  # noqa: E501
        if currency_conversion_response is not None:
            self.currency_conversion_response = currency_conversion_response  # noqa: E501
    ...
    def merchant_id(self):
        """Gets the merchant_id of this TransactionResponse.  # noqa: E501
        ...
        :return: The merchant_id of this TransactionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def merchant_id(
            self,
            merchant_id):
        """Sets the merchant_id of this TransactionResponse.

        The unique (on Acquirer level) mechant ID. Usually this value has been chosen from the merchant itself and will be used in communication with the endpoint.  # noqa: E501

        :param merchant_id: The merchant_id of this TransactionResponse.  # noqa: E501
        :type: str
        """
    ...
    def authentication_response(self):
        """Gets the authentication_response of this TransactionResponse.  # noqa: E501


        :return: The authentication_response of this TransactionResponse.  # noqa: E501
    ...
    def authentication_response(
        ...
        """Sets the authentication_response of this TransactionResponse.


        :param authentication_response: The authentication_response of this TransactionResponse.  # noqa: E501
    ...
    def account_updater_response(
        ...
        self._account_updater_response = (
            account_updater_response)

    @property
    def ach_response(self):
        """Gets the ach_response of this TransactionResponse.  # noqa: E501


        :return: The ach_response of this TransactionResponse.  # noqa: E501
        :rtype: AchResponse
        """
    ...
    def ach_response(
            self,
            ach_response):
        """Sets the ach_response of this TransactionResponse.


        :param ach_response: The ach_response of this TransactionResponse.  # noqa: E501
        :type: AchResponse
        """
    ...
    def currency_conversion_response(self):
        """Gets the currency_conversion_response of this TransactionResponse.  # noqa: E501


        :return: The currency_conversion_response of this TransactionResponse.  # noqa: E501
    ...
    def currency_conversion_response(
        ...
        """Sets the currency_conversion_response of this TransactionResponse.


        :param currency_conversion_response: The currency_conversion_response of this TransactionResponse.  # noqa: E501
        :type: CurrencyConversionResponse
        """

        self._currency_conversion_response = (
            currency_conversion_response)
