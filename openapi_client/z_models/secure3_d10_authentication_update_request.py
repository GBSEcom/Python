...
class Secure3D10AuthenticationUpdateRequest(object):
    ...
    def __init__(self, authentication_type, payer_authentication_response, merchant_data, store_id=None, billing_address=None, security_code=None):  # noqa: E501
        """Secure3D10AuthenticationUpdateRequest - a model defined in OpenAPI
