...
class SoftDescriptor(object):
    ...
    attribute_map = {
        ...
        'customer_service_number': 'customerServiceNumber',  # noqa: E501
        'mcc': 'mcc',  # noqa: E501
        'dynamic_address': 'dynamicAddress',  # noqa: E501
    }

    def __init__(self, dynamic_merchant_name, customer_service_number=None, mcc=None, dynamic_address=None):  # noqa: E501
        """SoftDescriptor - a model defined in OpenAPI

        Args:
            dynamic_merchant_name (str): Store \&quot;doing-business-as\&quot; name.

        Keyword Args:  # noqa: E501
            customer_service_number (str): Customer service phone number information that is passed to the issuer (it may appear on the cardholder’s statement) or if merchant wants to pass information that differs from the information stored on our master File.. [optional]  # noqa: E501
            mcc (str): The 4-digit merchant category code (MCC). The merchant might be associated with multiple MCCs. In that case the MCC provided here will be the one that better describes the current transaction.. [optional]  # noqa: E501
            dynamic_address (Address): [optional]  # noqa: E501
        """
        ...
        if customer_service_number is not None:
            self.customer_service_number = customer_service_number  # noqa: E501
        if mcc is not None:
            self.mcc = mcc  # noqa: E501
        if dynamic_address is not None:
            self.dynamic_address = dynamic_address  # noqa: E501
