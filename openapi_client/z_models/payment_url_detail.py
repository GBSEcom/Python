...
class PaymentUrlDetail(object):
    ...
    def __init__(self, payment_url=None, merchant_transaction_id=None, order_id=None, request_time=None, status=None):  # noqa: E501
        """PaymentUrlDetail - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request_time (int): The transaction time in seconds since epoch.. [optional]  # noqa: E501
            status (PaymentUrlStatus): [optional]  # noqa: E501
        """
