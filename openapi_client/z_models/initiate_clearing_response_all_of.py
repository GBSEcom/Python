...
class InitiateClearingResponseAllOf(object):
    ...
    attribute_map = {
        ...
        'clearing_details': 'clearingDetails',  # noqa: E501
        'endpoint_responses': 'endpointResponses',  # noqa: E501
    }

    def __init__(self, request_status=None, clearing_details=None, endpoint_responses=None):  # noqa: E501
        """InitiateClearingResponseAllOf - a model defined in OpenAPI



        Keyword Args:
            request_status (str): Request status. If it is anything other than &#39;SUCCESS&#39;, please refer to 400s HTTP error codes or decline. See Error object for details.. [optional]  # noqa: E501
            clearing_details (ClearingDetails): [optional]  # noqa: E501
            endpoint_responses (list[EndpointResponse]): The array holds response information of the involved endpoints.. [optional]  # noqa: E501
        """
        ...
        if clearing_details is not None:
            self.clearing_details = clearing_details  # noqa: E501
        if endpoint_responses is not None:
            self.endpoint_responses = endpoint_responses  # noqa: E501
