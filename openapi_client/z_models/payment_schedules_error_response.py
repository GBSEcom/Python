...
class PaymentSchedulesErrorResponse(object):
    ...
    attribute_map = {
        ...
        'transaction_response': 'transactionResponse',  # noqa: E501
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, request_status=None, order_id=None, transaction_response=None, error=None):  # noqa: E501
        """PaymentSchedulesErrorResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request_status (str): Result of requested operation. If it&#39;s anything other than &#39;SUCCESS&#39;, please refer to 400s HTTP error codes or decline. See Error object for details.. [optional]  # noqa: E501
            order_id (str): Client order ID if supplied by client, otherwise the order ID.. [optional]  # noqa: E501
            transaction_response (TransactionResponse): [optional]  # noqa: E501
        ...
        if transaction_response is not None:
            self.transaction_response = transaction_response  # noqa: E501
