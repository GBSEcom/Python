...
class ReceiptRequestInfo(object):
    ...
    attribute_map = {
        ...
        'linewidth': 'linewidth',  # noqa: E501
    }

    def __init__(self, type, locale=None, linewidth=None):  # noqa: E501
        """ReceiptRequestInfo - a model defined in OpenAPI

        Args:
            type (str): Defines the consumer of the receipt (e.g. cardholder, merchant).

        Keyword Args:  # noqa: E501
            locale (str): The locale of the receipt. The format has to be a well-formed BCP 47 language tag.. [optional]  # noqa: E501
            linewidth (int): The line width of the receipt. Default will be 32 characters.. [optional] if omitted the server will use the default value of 32  # noqa: E501
        """
        ...
        if linewidth is not None:
            self.linewidth = linewidth  # noqa: E501
