...
class Payment(object):
    ...
    attribute_map = {
        ...
        'pin_present': 'pinPresent',  # noqa: E501
        'entry_method': 'entryMethod',  # noqa: E501
        'issuer_response': 'issuerResponse',  # noqa: E501
        'issuer_approved_amount': 'issuerApprovedAmount',  # noqa: E501
        'issuer_card_balance': 'issuerCardBalance',  # noqa: E501
        'verification_avs': 'verificationAvs',  # noqa: E501
        'verification3ds': 'verification3ds',  # noqa: E501
        'verification_cvv': 'verificationCvv',  # noqa: E501
        'user_defined': 'userDefined',  # noqa: E501
    }

    def __init__(self, payment_type, method, pin_present, entry_method, issuer_response=None, issuer_approved_amount=None, issuer_card_balance=None, verification_avs=None, verification3ds=None, verification_cvv=None, user_defined=None):  # noqa: E501
        ...
        Keyword Args:  # noqa: E501  # noqa: E501  # noqa: E501  # noqa: E501
            issuer_response (IssuerResponse): [optional]  # noqa: E501
            issuer_approved_amount (str): The actual approved amount. This field should be filled in when the message has already passed through the issuer (e.g. post-authorization). For transaction/authorization this amount refers to the amount that was locked on the card-holders account.. [optional]  # noqa: E501
            issuer_card_balance (str): The payment methods account balance if available. This field should be filled in when the message has already passed through the issuer (e.g. post-authorization).. [optional]  # noqa: E501
            verification_avs (VerificationAvs): [optional]  # noqa: E501
            verification3ds (Verification3ds): [optional]  # noqa: E501
            verification_cvv (VerificationCvv): [optional]  # noqa: E501
            user_defined (object): A JSON object that carries any additional information that might be helpful for fraud detection.. [optional]  # noqa: E501
        """
        ...
        if issuer_response is not None:
            self.issuer_response = issuer_response  # noqa: E501
        if issuer_approved_amount is not None:
            self.issuer_approved_amount = issuer_approved_amount  # noqa: E501
        if issuer_card_balance is not None:
            self.issuer_card_balance = issuer_card_balance  # noqa: E501
        if verification_avs is not None:
            self.verification_avs = verification_avs  # noqa: E501
        if verification3ds is not None:
            self.verification3ds = verification3ds  # noqa: E501
        if verification_cvv is not None:
            self.verification_cvv = verification_cvv  # noqa: E501
