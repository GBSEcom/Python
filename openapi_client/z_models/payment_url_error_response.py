...
class PaymentUrlErrorResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, request_status=None, order_id=None, payment_url=None, transaction_id=None, error=None):  # noqa: E501
        """PaymentUrlErrorResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            payment_url (str): URL for embedded payment link.. [optional]  # noqa: E501
            transaction_id (str): ID code from the transaction.. [optional]  # noqa: E501
        ...
        if payment_url is not None:
            self.payment_url = payment_url  # noqa: E501
