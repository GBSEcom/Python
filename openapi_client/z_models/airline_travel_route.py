...
class AirlineTravelRoute(object):
    ...
    attribute_map = {
        'departure_date': 'departureDate',  # noqa: E501
        'origin': 'origin',  # noqa: E501
        'destination': 'destination',  # noqa: E501
        'carrier_code': 'carrierCode',  # noqa: E501
        'service_class': 'serviceClass',  # noqa: E501
        'stopover_type': 'stopoverType',  # noqa: E501
        'fare_basis_code': 'fareBasisCode',  # noqa: E501
        'departure_tax': 'departureTax',  # noqa: E501
        'flight_number': 'flightNumber',  # noqa: E501
    }
    ...
    def __init__(self, departure_date=None, origin=None, destination=None, carrier_code=None, service_class=None, stopover_type=None, fare_basis_code=None, departure_tax=None, flight_number=None):  # noqa: E501
        """AirlineTravelRoute - a model defined in OpenAPI



        Keyword Args:
            departure_date (date): Date of departure.. [optional]  # noqa: E501
            origin (str): The IATA code for the departure airport.. [optional]  # noqa: E501
            destination (str): The IATA code for the destination. airport.. [optional]  # noqa: E501
            carrier_code (str): The IATA code for the carrier.. [optional]  # noqa: E501
            service_class (str): The airline code for the service class of the ticket.. [optional]  # noqa: E501
            stopover_type (str): Indicates whether the route is direct.. [optional]  # noqa: E501
            fare_basis_code (str): The airline fare basis code.. [optional]  # noqa: E501
            departure_tax (float): Fee charged by a country when a person leaves the country.. [optional]  # noqa: E501
            flight_number (str): The airline flight number associated with the ticket.. [optional]  # noqa: E501
        """
        ...
        if departure_date is not None:
            self.departure_date = departure_date  # noqa: E501
        if origin is not None:
            self.origin = origin  # noqa: E501
        if destination is not None:
            self.destination = destination  # noqa: E501
        if carrier_code is not None:
            self.carrier_code = carrier_code  # noqa: E501
        if service_class is not None:
            self.service_class = service_class  # noqa: E501
        if stopover_type is not None:
            self.stopover_type = stopover_type  # noqa: E501
        if fare_basis_code is not None:
            self.fare_basis_code = fare_basis_code  # noqa: E501
        if departure_tax is not None:
            self.departure_tax = departure_tax  # noqa: E501
        if flight_number is not None:
            self.flight_number = flight_number  # noqa: E501
