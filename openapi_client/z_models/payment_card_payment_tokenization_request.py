...
class PaymentCardPaymentTokenizationRequest(object):
    ...
    def __init__(self, request_type, create_token, payment_card, store_id=None, billing_address=None, account_verification=None, merchant_transaction_id=None, additional_details=None):  # noqa: E501
        """PaymentCardPaymentTokenizationRequest - a model defined in OpenAPI
