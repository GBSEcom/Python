...
class PaymentCardSaleTransactionAllOf(object):
    ...
    def __init__(self, payment_method, stored_credentials=None, settlement_split=None, create_token=None, currency_conversion=None, authentication_request=None, authentication_result=None):  # noqa: E501
        """PaymentCardSaleTransactionAllOf - a model defined in OpenAPI
