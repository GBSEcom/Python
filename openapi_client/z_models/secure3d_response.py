...
class Secure3dResponse(object):
    ...
    attribute_map = {
        'response_code3d_secure': 'responseCode3dSecure',  # noqa: E501
    }

    def __init__(self, response_code3d_secure=None):  # noqa: E501
        """Secure3dResponse - a model defined in OpenAPI



        Keyword Args:
            response_code3d_secure (str): Code received after successful payer-auth verification.. [optional]  # noqa: E501
        """
        ...
        if response_code3d_secure is not None:
            self.response_code3d_secure = response_code3d_secure  # noqa: E501
    ...
    def response_code3d_secure(
            self,
            response_code3d_secure):
