...
class StoreEmailSettings(object):
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'email_notification_data': 'emailNotificationData',  # noqa: E501
    }

    def __init__(self, id, email_notification_data):  # noqa: E501
        """StoreEmailSettings - a model defined in OpenAPI
