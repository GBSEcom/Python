...
class ExchangeRateDetails(object):
    ...
    attribute_map = {
        ...
        'dcc_offered': 'dccOffered',  # noqa: E501
        'exchange_rate_source_timestamp': 'exchangeRateSourceTimestamp',  # noqa: E501
        'expiration_timestamp': 'expirationTimestamp',  # noqa: E501
        'margin_rate_percentage': 'marginRatePercentage',  # noqa: E501
        'exchange_rate_source_name': 'exchangeRateSourceName',  # noqa: E501
    }
    ...
    def __init__(self, inquiry_rate_id=None, foreign_currency=None, foreign_amount=None, exchange_rate=None, dcc_offered=None, exchange_rate_source_timestamp=None, expiration_timestamp=None, margin_rate_percentage=None, exchange_rate_source_name=None):  # noqa: E501
        """ExchangeRateDetails - a model defined in OpenAPI



        Keyword Args:
            inquiry_rate_id (str): Inquiry rate ID.. [optional]  # noqa: E501
            foreign_currency (str): Foreign currency in alphabetic ISO 4217 currency code format.. [optional]  # noqa: E501
            foreign_amount (str): Foreign amount.. [optional]  # noqa: E501
            exchange_rate (str): Exchange rate.. [optional]  # noqa: E501
            dcc_offered (bool): Dcc offered.. [optional]  # noqa: E501
            exchange_rate_source_timestamp (str): Exchange rate source timestamp. The used format is \&quot;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSXXX\&quot;. [optional]  # noqa: E501
            expiration_timestamp (str): Expiration timestamp. The used format is \&quot;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSXXX\&quot;. [optional]  # noqa: E501
            margin_rate_percentage (str): Margin rate percentage.. [optional]  # noqa: E501
            exchange_rate_source_name (str): Exchange rate source name.. [optional]  # noqa: E501
        """
        ...
        if inquiry_rate_id is not None:
            self.inquiry_rate_id = inquiry_rate_id  # noqa: E501
        if foreign_currency is not None:
            self.foreign_currency = foreign_currency  # noqa: E501
        if foreign_amount is not None:
            self.foreign_amount = foreign_amount  # noqa: E501
        if exchange_rate is not None:
            self.exchange_rate = exchange_rate  # noqa: E501
        if dcc_offered is not None:
            self.dcc_offered = dcc_offered  # noqa: E501
        if exchange_rate_source_timestamp is not None:
            self.exchange_rate_source_timestamp = exchange_rate_source_timestamp  # noqa: E501
        if expiration_timestamp is not None:
            self.expiration_timestamp = expiration_timestamp  # noqa: E501
        if margin_rate_percentage is not None:
            self.margin_rate_percentage = margin_rate_percentage  # noqa: E501
        if exchange_rate_source_name is not None:
            self.exchange_rate_source_name = exchange_rate_source_name  # noqa: E501
    ...
    def exchange_rate_source_timestamp(
            self,
            exchange_rate_source_timestamp):
        ...
        self._exchange_rate_source_timestamp = (
            exchange_rate_source_timestamp)
    ...
    def exchange_rate_source_name(
        ...
        self._exchange_rate_source_name = (
            exchange_rate_source_name)
