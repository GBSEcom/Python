...
class AccessTokenResponse(object):
    ...
    attribute_map = {
        ...
        'public_key_base64': 'publicKeyBase64',  # noqa: E501
    ...
    def __init__(self, token_id=None, status=None, issued_on=None, expires_in_seconds=None, public_key_base64=None, algorithm=None, client_request_id=None):  # noqa: E501
        ...
        Keyword Args:
            token_id (str): Access token for authentication.. [optional]  # noqa: E501
            status (str): The token status.. [optional]  # noqa: E501
            issued_on (str): Access token issued time in milliseconds.. [optional]  # noqa: E501
            expires_in_seconds (str): Access token expiration time.. [optional]  # noqa: E501
            public_key_base64 (str): Public key to encrypt data.. [optional]  # noqa: E501
            algorithm (str): Encyption algorithym. One way ECDH 256 bit key.. [optional]  # noqa: E501
            client_request_id (str): Echoes back the value from the request header for tracking.. [optional]  # noqa: E501
        """
        ...
        if token_id is not None:
            self.token_id = token_id  # noqa: E501
        if status is not None:
            self.status = status  # noqa: E501
        if issued_on is not None:
            self.issued_on = issued_on  # noqa: E501
        if expires_in_seconds is not None:
            self.expires_in_seconds = expires_in_seconds  # noqa: E501
        if public_key_base64 is not None:
            self.public_key_base64 = public_key_base64  # noqa: E501
        if algorithm is not None:
            self.algorithm = algorithm  # noqa: E501
