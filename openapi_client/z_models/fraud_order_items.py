...
class FraudOrderItems(object):
    ...
    attribute_map = {
        ...
        'details_url': 'detailsUrl',  # noqa: E501
    ...
    def __init__(self, id=None, name=None, quantity=None, unit=None, unit_price=None, categories=None, details_url=None, user_defined=None):  # noqa: E501
        """FraudOrderItems - a model defined in OpenAPI



        Keyword Args:
            id (str): A unique ID associated with the product. Must be unique within the merchant&#39;s system.. [optional]  # noqa: E501
            name (str): A name or short description of the product.. [optional]  # noqa: E501
            quantity (str): The unit in which the product is sold (e.g. litre, kilogram, etc). Leave empty if the product is sold as a complete unit.. [optional]  # noqa: E501
            unit (str): The number of units sold. Set to 1 if there is only one unit of the item. Leave empty if the quantity is unknown at the time of the request.. [optional]  # noqa: E501
            unit_price (str): The price per unit.. [optional]  # noqa: E501
            categories (list[list[str]]): The categories that this product belongs to.. [optional]  # noqa: E501
            details_url (str): The URL to the merchant&#39;s management system, for reporting and analysis.. [optional]  # noqa: E501
            user_defined (object): A JSON object that can carry any additional information about the order that might be helpful for fraud detection.. [optional]  # noqa: E501
        """
        ...
        if unit is not None:
            self.unit = unit  # noqa: E501
        if unit_price is not None:
            self.unit_price = unit_price  # noqa: E501
        if categories is not None:
            self.categories = categories  # noqa: E501
        if details_url is not None:
            self.details_url = details_url  # noqa: E501
