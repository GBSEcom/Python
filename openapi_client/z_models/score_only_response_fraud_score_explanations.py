...
class ScoreOnlyResponseFraudScoreExplanations(object):
    ...
    def __init__(self, description=None, rule=None, type=None):  # noqa: E501
        """ScoreOnlyResponseFraudScoreExplanations - a model defined in OpenAPI



        Keyword Args:
            description (str): Description of the fraud score explanation.. [optional]  # noqa: E501
            rule (str): ID of the rule being triggered.. [optional]  # noqa: E501
            type (str): Type of the explanation (model or rule).. [optional]  # noqa: E501
        """
