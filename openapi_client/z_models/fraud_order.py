...
class FraudOrder(object):
    ...
    def __init__(self, ship_to_address=None, items=None, details_url=None, user_defined=None):  # noqa: E501
        """FraudOrder - a model defined in OpenAPI



        Keyword Args:
            ship_to_address (ShipToAddress): [optional]  # noqa: E501
            items (list[FraudOrderItems]): The list of items included in the order.. [optional]  # noqa: E501
        ...
        if ship_to_address is not None:
            self.ship_to_address = ship_to_address  # noqa: E501
        if items is not None:
            self.items = items  # noqa: E501
