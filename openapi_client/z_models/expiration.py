...
class Expiration(object):
    ...
    def __init__(self, month, year):  # noqa: E501
    ...
    def year(
        ...
        if year is not None and not re.search(r'^([0-9]{2})$', year):  # noqa: E501
            raise ValueError(r"Invalid value for `year`, must be a follow pattern or equal to `/^([0-9]{2})$/`")  # noqa: E501
