...
class AVSResponse(object):
    ...
    attribute_map = {
        'street_match': 'streetMatch',  # noqa: E501
        'postal_code_match': 'postalCodeMatch',  # noqa: E501
        'association_avs_response': 'associationAvsResponse',  # noqa: E501
    }

    def __init__(self, street_match=None, postal_code_match=None, association_avs_response=None):  # noqa: E501
        """AVSResponse - a model defined in OpenAPI



        Keyword Args:
            street_match (str): Response if street matches that on file.. [optional]  # noqa: E501
            postal_code_match (str): Response if postal code matches that on file.. [optional]  # noqa: E501
            association_avs_response (str): The raw address verification response code returned by issuer. Please refer to response codes section in developer portal for more info.. [optional]  # noqa: E501
        """
        ...
        if street_match is not None:
            self.street_match = street_match  # noqa: E501
        if postal_code_match is not None:
            self.postal_code_match = postal_code_match  # noqa: E501
        if association_avs_response is not None:
            self.association_avs_response = association_avs_response  # noqa: E501
    ...
    def association_avs_response(
            self,
            association_avs_response):
        ...
        self._association_avs_response = (
            association_avs_response)
