...
class PaymentDevicePreAuthTransactionAllOf(object):
    ...
    def __init__(self, payment_method, create_token=None, settlement_split=None, stored_credentials=None, split_shipment=None, decremental_flag=None):  # noqa: E501
        """PaymentDevicePreAuthTransactionAllOf - a model defined in OpenAPI
    ...
    def decremental_flag(self):
        """Gets the decremental_flag of this PaymentDevicePreAuthTransactionAllOf.  # noqa: E501
        ...
        :return: The decremental_flag of this PaymentDevicePreAuthTransactionAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def decremental_flag(
            self,
            decremental_flag):
        """Sets the decremental_flag of this PaymentDevicePreAuthTransactionAllOf.

        This flag can only be used in a preAuth transaction that updates the amount of a previous preAuth transaction to either increase the preAuth amount (DecrementalPreAuthFlag = false) or decrease the preAuth amount (DecrementalPreAuthFlag = true).  # noqa: E501

        :param decremental_flag: The decremental_flag of this PaymentDevicePreAuthTransactionAllOf.  # noqa: E501
        :type: bool
        """
