...
class FraudRegistrationDeviceItems(object):
    ...
    def __init__(self, network_type, ip=None, mac=None, ssid=None, bssid=None, user_defined=None):  # noqa: E501
        """FraudRegistrationDeviceItems - a model defined in OpenAPI
