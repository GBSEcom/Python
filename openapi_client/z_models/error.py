...
class Error(object):
    ...
    def __init__(self, code=None, message=None, details=None):  # noqa: E501
        ...
        Keyword Args:
            code (str): Uniquely identifies an error condition. Client applications need to read and handle errors based on this.. [optional]  # noqa: E501
            message (str): A generic description of the error condition.. [optional]  # noqa: E501
            details (list[ErrorDetails]): Detailed information about message format errors.. [optional]  # noqa: E501
        """
        ...
        if details is not None:
            self.details = details  # noqa: E501
