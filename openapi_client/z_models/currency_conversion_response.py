...
class CurrencyConversionResponse(object):
    ...
    attribute_map = {
        'dcc_applied': 'dccApplied',  # noqa: E501
    ...
    def __init__(self, dcc_applied=None, exchange_rate_details=None):  # noqa: E501
        """CurrencyConversionResponse - a model defined in OpenAPI



        Keyword Args:
            dcc_applied (bool): Dynamic Currency Conversion Applied.. [optional]  # noqa: E501
        ...
        if dcc_applied is not None:
            self.dcc_applied = dcc_applied  # noqa: E501
