...
class PaymentTokenSaleTransaction(object):
    ...
    def __init__(self, request_type, transaction_amount, payment_method, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None, stored_credentials=None, settlement_split=None, currency_conversion=None, authentication_request=None, authentication_result=None):  # noqa: E501
        """PaymentTokenSaleTransaction - a model defined in OpenAPI
