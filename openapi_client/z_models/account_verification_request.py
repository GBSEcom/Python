...
class AccountVerificationRequest(object):
    ...
    def __init__(self, request_type, billing_address=None, store_id=None, merchant_transaction_id=None, additional_details=None):  # noqa: E501
        """AccountVerificationRequest - a model defined in OpenAPI
