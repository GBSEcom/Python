...
class WalletPreAuthTransactionAllOf(object):
    ...
    def __init__(self, wallet_payment_method, split_shipment=None, payment_facilitator=None, decremental_flag=None):  # noqa: E501
        """WalletPreAuthTransactionAllOf - a model defined in OpenAPI
