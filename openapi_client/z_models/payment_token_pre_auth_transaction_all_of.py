...
class PaymentTokenPreAuthTransactionAllOf(object):
    ...
    def __init__(self, payment_method, stored_credentials=None, split_shipment=None, settlement_split=None, authentication_request=None, authentication_result=None, decremental_flag=None):  # noqa: E501
        """PaymentTokenPreAuthTransactionAllOf - a model defined in OpenAPI
