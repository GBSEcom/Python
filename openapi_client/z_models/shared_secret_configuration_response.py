...
class SharedSecretConfigurationResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, store_id=None, shared_secret=None, response_message=None, response_timestamp=None):  # noqa: E501
        """SharedSecretConfigurationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            shared_secret (str): Shared secret/password for Connect.. [optional]  # noqa: E501
            response_message (str): The message/status received after updating shared secret service config.. [optional]  # noqa: E501
            response_timestamp (int): Response timestamp.. [optional]  # noqa: E501
        """
        ...
        if shared_secret is not None:
            self.shared_secret = shared_secret  # noqa: E501
        if response_message is not None:
            self.response_message = response_message  # noqa: E501
        if response_timestamp is not None:
            self.response_timestamp = response_timestamp  # noqa: E501
