...
class Loyalty(object):
    ...
    def __init__(self, id=None, program=None, balance=None):  # noqa: E501
        """Loyalty - a model defined in OpenAPI



        Keyword Args:
            id (str): A unique ID associated with the loyalty program account. Must be unique within the merchants system. Depending on loyalty programs the account might also serve as a credit/bank account. If this is the case the ID must be not be the PAN.. [optional]  # noqa: E501
            program (str): A string that identifies the program in which the customer is enrolled if the merchant supports several programs or levels.. [optional]  # noqa: E501
            balance (float): The balance of the loyalty program account in a program specific currency (e.g. points).. [optional]  # noqa: E501
        """
        ...
        if program is not None:
            self.program = program  # noqa: E501
        if balance is not None:
            self.balance = balance  # noqa: E501
