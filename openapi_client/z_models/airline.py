...
class Airline(object):
    ...
    attribute_map = {
        'passenger_name': 'passengerName',  # noqa: E501
        'ticket_number': 'ticketNumber',  # noqa: E501
        'issuing_carrier': 'issuingCarrier',  # noqa: E501
        'carrier_name': 'carrierName',  # noqa: E501
        'travel_agency_iata_code': 'travelAgencyIataCode',  # noqa: E501
        'travel_agency_name': 'travelAgencyName',  # noqa: E501
        'airline_plan_number': 'airlinePlanNumber',  # noqa: E501
        'airline_invoice_number': 'airlineInvoiceNumber',  # noqa: E501
        'reservation_system': 'reservationSystem',  # noqa: E501
        'restricted': 'restricted',  # noqa: E501
        'travel_route': 'travelRoute',  # noqa: E501
        'related_ticket_number': 'relatedTicketNumber',  # noqa: E501
        'ancillary_service_category': 'ancillaryServiceCategory',  # noqa: E501
        'ticket_purchase': 'ticketPurchase',  # noqa: E501
    }
    ...
    def __init__(self, passenger_name=None, ticket_number=None, issuing_carrier=None, carrier_name=None, travel_agency_iata_code=None, travel_agency_name=None, airline_plan_number=None, airline_invoice_number=None, reservation_system=None, restricted=None, travel_route=None, related_ticket_number=None, ancillary_service_category=None, ticket_purchase=None):  # noqa: E501
        ...
        Keyword Args:
            passenger_name (str): The passenger name associated with the transaction.. [optional]  # noqa: E501
            ticket_number (str): The airline ticket number associated with the transaction.. [optional]  # noqa: E501
            issuing_carrier (str): The carrier that issued the ticket.. [optional]  # noqa: E501
            carrier_name (str): The carrier associated with the transaction.. [optional]  # noqa: E501
            travel_agency_iata_code (str): The IATA code associated with the travel agency.. [optional]  # noqa: E501
            travel_agency_name (str): The business name of the travel agency.. [optional]  # noqa: E501
            airline_plan_number (str): The airline plan number associated with the transaction.. [optional]  # noqa: E501
            airline_invoice_number (str): The invoice number used by the airline.. [optional]  # noqa: E501
            reservation_system (str): The reservation system used to create the ticket.. [optional]  # noqa: E501
            restricted (bool): If the transaction is associated with a restricted class fare.. [optional]  # noqa: E501
            travel_route (list[AirlineTravelRoute]): Array containing up to 4 items that describe the route associated with the transaction.. [optional]  # noqa: E501
            related_ticket_number (str): The number of any other tickets associated with the transaction ticket.. [optional]  # noqa: E501
            ancillary_service_category (list[AirlineAncillaryServiceCategory]): Identify the purchase of ancillary goods or services with a false value. If this element is not provided, the transaction is assumed to be a purchase of an airline ticket.. [optional]  # noqa: E501
            ticket_purchase (bool): Identifies if the transaction is a ticket purchase.. [optional]  # noqa: E501
        """
        ...
        if passenger_name is not None:
            self.passenger_name = passenger_name  # noqa: E501
        if ticket_number is not None:
            self.ticket_number = ticket_number  # noqa: E501
        if issuing_carrier is not None:
            self.issuing_carrier = issuing_carrier  # noqa: E501
        if carrier_name is not None:
            self.carrier_name = carrier_name  # noqa: E501
        if travel_agency_iata_code is not None:
            self.travel_agency_iata_code = travel_agency_iata_code  # noqa: E501
        if travel_agency_name is not None:
            self.travel_agency_name = travel_agency_name  # noqa: E501
        if airline_plan_number is not None:
            self.airline_plan_number = airline_plan_number  # noqa: E501
        if airline_invoice_number is not None:
            self.airline_invoice_number = airline_invoice_number  # noqa: E501
        if reservation_system is not None:
            self.reservation_system = reservation_system  # noqa: E501
        if restricted is not None:
            self.restricted = restricted  # noqa: E501
        if travel_route is not None:
            self.travel_route = travel_route  # noqa: E501
        if related_ticket_number is not None:
            self.related_ticket_number = related_ticket_number  # noqa: E501
        if ancillary_service_category is not None:
            self.ancillary_service_category = ancillary_service_category  # noqa: E501
        if ticket_purchase is not None:
            self.ticket_purchase = ticket_purchase  # noqa: E501
    ...
    def ancillary_service_category(
        ...
        self._ancillary_service_category = (
            ancillary_service_category)
