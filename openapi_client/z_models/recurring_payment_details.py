...
class RecurringPaymentDetails(object):
    ...
    attribute_map = {
        ...
        'next_attempt_date': 'nextAttemptDate',  # noqa: E501
    ...
    def __init__(self, store_id=None, purchase_order_number=None, invoice_number=None, creation_date=None, start_date=None, next_attempt_date=None, transaction_amount=None, payment_method_details=None, frequency=None, number_of_payments=None, run_count=None, state=None, comments=None):  # noqa: E501
        """RecurringPaymentDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            creation_date (str): Date recurring payment was created.. [optional]  # noqa: E501
            start_date (str): Date of mandate signature.. [optional]  # noqa: E501
            next_attempt_date (str): Date of next transaction process attempt.. [optional]  # noqa: E501
            ...
            run_count (int): Times the recurring payment has already run.. [optional]  # noqa: E501
            state (str): State of the recurring payment.. [optional]  # noqa: E501
        ...
        if creation_date is not None:
            self.creation_date = creation_date  # noqa: E501
        if start_date is not None:
            self.start_date = start_date  # noqa: E501
        if next_attempt_date is not None:
            self.next_attempt_date = next_attempt_date  # noqa: E501
        if transaction_amount is not None:
            self.transaction_amount = transaction_amount  # noqa: E501
        if payment_method_details is not None:
            self.payment_method_details = payment_method_details  # noqa: E501
        if frequency is not None:
            self.frequency = frequency  # noqa: E501
        if number_of_payments is not None:
            self.number_of_payments = number_of_payments  # noqa: E501
        if run_count is not None:
            self.run_count = run_count  # noqa: E501
