...
class ProcessorData(object):
    ...
    attribute_map = {
        ...
        'association_response_code': 'associationResponseCode',  # noqa: E501
        'response_message': 'responseMessage',  # noqa: E501
        'avs_response': 'avsResponse',  # noqa: E501
        'security_code_response': 'securityCodeResponse',  # noqa: E501
        'merchant_advice_code_indicator': 'merchantAdviceCodeIndicator',  # noqa: E501
        'response_indicator': 'responseIndicator',  # noqa: E501
        'debit_receipt_number': 'debitReceiptNumber',  # noqa: E501
        'transaction_integrity_class': 'transactionIntegrityClass',  # noqa: E501
    }

    def __init__(self, reference_number=None, authorization_code=None, response_code=None, network=None, association_response_code=None, response_message=None, avs_response=None, security_code_response=None, merchant_advice_code_indicator=None, response_indicator=None, debit_receipt_number=None, transaction_integrity_class=None):  # noqa: E501
        """ProcessorData - a model defined in OpenAPI



        Keyword Args:
            reference_number (str): Reference transaction ID.. [optional]  # noqa: E501
            authorization_code (str): Code returned to confirm transaction.. [optional]  # noqa: E501
            response_code (str): Response code from endpoints.. [optional]  # noqa: E501
            network (str): Network used for transaction.. [optional]  # noqa: E501
            association_response_code (str): Raw response code from issuer.. [optional]  # noqa: E501
            response_message (str): Message returned from endpoints.. [optional]  # noqa: E501
            avs_response (AVSResponse): [optional]  # noqa: E501
            security_code_response (str): Code returned for CVV.. [optional]  # noqa: E501
            merchant_advice_code_indicator (str): Code to map merchant advice code to ISO specification.. [optional]  # noqa: E501
            response_indicator (str): Indicates whether the transaction was routed through the payment card&#39;s own network or through a different network.. [optional]  # noqa: E501
            debit_receipt_number (str): Receipt number from debit network provider.. [optional]  # noqa: E501
            transaction_integrity_class (str): MasterCard provided Transaction Integrity Class for Point of Sale (POS) Purchase and Purchase with Cash Back transactions initiated on the Authorization Platform.. [optional]  # noqa: E501
        """
        ...
        if reference_number is not None:
            self.reference_number = reference_number  # noqa: E501
        if authorization_code is not None:
            self.authorization_code = authorization_code  # noqa: E501
        if response_code is not None:
            self.response_code = response_code  # noqa: E501
        if network is not None:
            self.network = network  # noqa: E501
        if association_response_code is not None:
            self.association_response_code = association_response_code  # noqa: E501
        if response_message is not None:
            self.response_message = response_message  # noqa: E501
        if avs_response is not None:
            self.avs_response = avs_response  # noqa: E501
        if security_code_response is not None:
            self.security_code_response = security_code_response  # noqa: E501
        if merchant_advice_code_indicator is not None:
            self.merchant_advice_code_indicator = merchant_advice_code_indicator  # noqa: E501
        if response_indicator is not None:
            self.response_indicator = response_indicator  # noqa: E501
        if debit_receipt_number is not None:
            self.debit_receipt_number = debit_receipt_number  # noqa: E501
        if transaction_integrity_class is not None:
            self.transaction_integrity_class = transaction_integrity_class  # noqa: E501
    ...
    def association_response_code(
        ...
        self._association_response_code = (
            association_response_code)
    ...
    def merchant_advice_code_indicator(
        ...
        self._merchant_advice_code_indicator = (
            merchant_advice_code_indicator)
    ...
    def transaction_integrity_class(
        ...
        self._transaction_integrity_class = (
            transaction_integrity_class)
