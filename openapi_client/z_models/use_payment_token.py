...
class UsePaymentToken(object):
    ...
    attribute_map = {
        ...
        'token_origin_store_id': 'tokenOriginStoreId',  # noqa: E501
        'function': 'function',  # noqa: E501
        'security_code': 'securityCode',  # noqa: E501
        'expiry_date': 'expiryDate',  # noqa: E501
    }

    def __init__(self, value, token_origin_store_id=None, function=None, security_code=None, expiry_date=None):  # noqa: E501
        """UsePaymentToken - a model defined in OpenAPI

        Args:
            value (str): Client-supplied payment token value.

        Keyword Args:  # noqa: E501
            token_origin_store_id (str): The ID of a same store (or) sibling store in a hierarchy for which the token was originally created.. [optional]  # noqa: E501
            function (CardFunction): [optional]  # noqa: E501
            security_code (str): Card verification value/number.. [optional]  # noqa: E501
            expiry_date (Expiration): [optional]  # noqa: E501
        """
        ...
        if token_origin_store_id is not None:
            self.token_origin_store_id = token_origin_store_id  # noqa: E501
        if function is not None:
            self.function = function  # noqa: E501
        if security_code is not None:
            self.security_code = security_code  # noqa: E501
        if expiry_date is not None:
            self.expiry_date = expiry_date  # noqa: E501
    ...
    def token_origin_store_id(
            self,
            token_origin_store_id):
