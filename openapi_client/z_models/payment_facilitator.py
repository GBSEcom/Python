...
class PaymentFacilitator(object):
    ...
    attribute_map = {
        'external_merchant_id': 'externalMerchantId',  # noqa: E501
        'payment_facilitator_id': 'paymentFacilitatorId',  # noqa: E501
        'name': 'name',  # noqa: E501
        'sale_organization_id': 'saleOrganizationId',  # noqa: E501
        'sub_merchant_data': 'subMerchantData',  # noqa: E501
    }

    def __init__(self, external_merchant_id, payment_facilitator_id, name, sale_organization_id=None, sub_merchant_data=None):  # noqa: E501
        """PaymentFacilitator - a model defined in OpenAPI
        ...
        Keyword Args:  # noqa: E501  # noqa: E501  # noqa: E501
            sale_organization_id (str): Independent sales organization (ISO) ID provided by Mastercard.. [optional]  # noqa: E501
            sub_merchant_data (SubMerchantData): [optional]  # noqa: E501
        """
        ...
        if sale_organization_id is not None:
            self.sale_organization_id = sale_organization_id  # noqa: E501
        self.name = name
        if sub_merchant_data is not None:
            self.sub_merchant_data = sub_merchant_data  # noqa: E501
