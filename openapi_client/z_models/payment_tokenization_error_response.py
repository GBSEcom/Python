...
class PaymentTokenizationErrorResponse(object):
    ...
    def __init__(self, client_request_id=None, api_trace_id=None, response_type=None, request_status=None, request_time=None, brand=None, country=None, payment_token=None, payment_card=None, processor=None, order_id=None, ipg_transaction_id=None, merchant_transaction_id=None, error=None):  # noqa: E501
        """PaymentTokenizationErrorResponse - a model defined in OpenAPI
