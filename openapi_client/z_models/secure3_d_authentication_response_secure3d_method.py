...
class Secure3DAuthenticationResponseSecure3dMethod(object):
    ...
    attribute_map = {
        'method_form': 'methodForm',  # noqa: E501
        'secure3d_trans_id': 'secure3dTransId',  # noqa: E501
    }

    def __init__(self, method_form=None, secure3d_trans_id=None):  # noqa: E501
        """Secure3DAuthenticationResponseSecure3dMethod - a model defined in OpenAPI



        Keyword Args:
            method_form (str): An iframe to be hidden in the browser used to collect browser data for the issuers. This information adds to the overall consumer profile and helps in identifying potentially fraudulent transactions.. [optional]  # noqa: E501
            secure3d_trans_id (str): A unique transaction identifier supplied by the ACS.. [optional]  # noqa: E501
        """
        ...
        if method_form is not None:
            self.method_form = method_form  # noqa: E501
        if secure3d_trans_id is not None:
            self.secure3d_trans_id = secure3d_trans_id  # noqa: E501
