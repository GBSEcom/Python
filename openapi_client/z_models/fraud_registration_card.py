...
class FraudRegistrationCard(object):
    ...
    attribute_map = {
        ...
        'cvv_present': 'cvvPresent',  # noqa: E501
    ...
    def __init__(self, cardholder_name=None, card_number=None, exp_date=None, cvv_present=None, issuer=None, card_reissued_number=None):  # noqa: E501
        """FraudRegistrationCard - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cvv_present (str): CVV present indicator.. [optional]  # noqa: E501
        ...
        if cvv_present is not None:
            self.cvv_present = cvv_present  # noqa: E501
