...
class PaymentCardForcedTicketTransaction(object):
    ...
    def __init__(self, request_type, transaction_amount, payment_method, reference_number, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None):  # noqa: E501
        """PaymentCardForcedTicketTransaction - a model defined in OpenAPI
