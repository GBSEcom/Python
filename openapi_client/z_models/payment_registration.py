...
class PaymentRegistration(object):
    ...
    attribute_map = {
        ...
        'original_transaction_type': 'originalTransactionType',  # noqa: E501
        'registration_method': 'registrationMethod',  # noqa: E501
        'merchant_ref': 'merchantRef',  # noqa: E501
    ...
    def __init__(self, transaction_type, customer, merchant, original_transaction_type, registration_method, merchant_ref=None, device=None, user_defined=None, issuer_response=None, verification_avs=None, verification3ds=None, verification_cvv=None):  # noqa: E501
        """PaymentRegistration - a model defined in OpenAPI
        ...
        Keyword Args:  # noqa: E501  # noqa: E501  # noqa: E501  # noqa: E501  # noqa: E501
            merchant_ref (str): Merchant reference code. Used by FirstAPI and reflected in settlement records and webhook notifications. Typically, the merchantRef field is the purchase order number or unique sequence value associated to a given transaction.. [optional]  # noqa: E501
            device (FraudRegistrationDevice): [optional]  # noqa: E501
            user_defined (object): A JSON object that can carry any additional information that might be helpful for fraud detection.. [optional]  # noqa: E501
            ...
            original_transaction_type (str): Defines the type of the original transaction that is being evaluated for the Fraud Score.. [optional]  # noqa: E501
            registration_method (RegistrationMethod): [optional]  # noqa: E501
        """
        ...
        if merchant_ref is not None:
            self.merchant_ref = merchant_ref  # noqa: E501
        self.transaction_type = transaction_type
        self.customer = customer
        self.merchant = merchant
        if device is not None:
            self.device = device  # noqa: E501
    ...
    def original_transaction_type(
        ...
        self._original_transaction_type = (
            original_transaction_type)
