...
class StoreBrandingStyleConfiguration(object):
    ...
    attribute_map = {
        ...
        'classic': 'classic',  # noqa: E501
    }

    def __init__(self, id, combined=None, classic=None):  # noqa: E501
        """StoreBrandingStyleConfiguration - a model defined in OpenAPI

        Args:
            id (str): An optional outlet id for clients that support multiple stores in the same developer app.

        Keyword Args:  # noqa: E501
            combined (CombinedMode): [optional]  # noqa: E501
            classic (ClassicMode): [optional]  # noqa: E501
        """
        ...
        if combined is not None:
            self.combined = combined  # noqa: E501
        if classic is not None:
            self.classic = classic  # noqa: E501
