...
class PaymentDevice(object):
    ...
    def __init__(self, data, device_type='SWIPE', security_code=None, cardholder_name=None, card_function=None, brand=None):  # noqa: E501
        """PaymentDevice - a model defined in OpenAPI

        Args:
            data (str): Data from device containing, at a minimum, a transaction-unique key serial number (KSN) and track 2 card data.

        Keyword Args:
            device_type (str): The data format.. defaults to 'SWIPE', must be one of ['SWIPE']  # noqa: E501  # noqa: E501
            security_code (str): Card verification value/number.. [optional]  # noqa: E501
            cardholder_name (str): Name of cardholder.. [optional]  # noqa: E501
