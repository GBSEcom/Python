...
class Secure3D21AuthenticationRequest(object):
    ...
    attribute_map = {
        ...
        'term_url': 'termURL',  # noqa: E501
        'method_notification_url': 'methodNotificationURL',  # noqa: E501
        'challenge_indicator': 'challengeIndicator',  # noqa: E501
        'challenge_window_size': 'challengeWindowSize',  # noqa: E501
    }

    def __init__(self, authentication_type, term_url=None, method_notification_url=None, challenge_indicator=None, challenge_window_size=None):  # noqa: E501
        """Secure3D21AuthenticationRequest - a model defined in OpenAPI
        ...
        Keyword Args:  # noqa: E501
            term_url (str): The result of the authentication will be sent to this URL. If not provided, a term URL will be dynamically generated. Note this must be a valid URL (special characters should be URL-encoded).. [optional]  # noqa: E501
            method_notification_url (str): The 3DS method iframe and transaction ID will be sent here. Note this must be a valid URL (special characters should be URL-encoded).. [optional]  # noqa: E501
            challenge_indicator (str): Indicates whether or not a challenge should be performed. 01 &#x3D; No preference (You have no preference whether a challenge should be performed. This is the default value) 02 &#x3D; No challenge requested (You prefer that no challenge should be performed) 03 &#x3D; Challenge requested: 3DS Requestor Preference (You prefer that a challenge should be performed) 04 &#x3D; Challenge requested: Mandate (There are local or regional mandates that mean that a challenge must be performed) . [optional] if omitted the server will use the default value of '01'  # noqa: E501
            challenge_window_size (str): Defines the size of the challenge window displayed to customers during authentication. 01 &#x3D; 250 x 400 02 &#x3D; 390 x 400 03 &#x3D; 500 x 600 04 &#x3D; 600 x 400 05 &#x3D; Full screen . [optional]  # noqa: E501
        """
        ...
        if term_url is not None:
            self.term_url = term_url  # noqa: E501
        if method_notification_url is not None:
            self.method_notification_url = method_notification_url  # noqa: E501
        if challenge_indicator is not None:
            self.challenge_indicator = challenge_indicator  # noqa: E501
        if challenge_window_size is not None:
            self.challenge_window_size = challenge_window_size  # noqa: E501
