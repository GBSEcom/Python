...
class Items(object):
    ...
    attribute_map = {
        ...
        'subscription_identification_number': 'subscriptionIdentificationNumber',  # noqa: E501
        'location_area_code': 'locationAreaCode',  # noqa: E501
        'cell_id': 'cellId',  # noqa: E501
        'standard': 'standard',  # noqa: E501
        'mac': 'mac',  # noqa: E501
        'ssid': 'ssid',  # noqa: E501
        'bssid': 'bssid',  # noqa: E501
        'user_defined': 'userDefined',  # noqa: E501
    }

    def __init__(self, network_type, ip=None, phone_number=None, carrier_name=None, mobile_country_code=None, mobile_network_code=None, subscription_identification_number=None, location_area_code=None, cell_id=None, standard=None, mac=None, ssid=None, bssid=None, user_defined=None):  # noqa: E501
        ...
        Keyword Args:  # noqa: E501
            ip (str): The IPv4 or IPv6 address of the device if the network assigned one.. [optional]  # noqa: E501
            phone_number (str): The devices primary phone number. This value should be supplied directly without any transformation (e.g. removal of spaces, hyphens or parentheses). If this data is available in segregated fields, it should be concatenated using a blank space (\&quot; \&quot;) as a separator.. [optional]  # noqa: E501
            carrier_name (str): The network carrier name.. [optional]  # noqa: E501
            mobile_country_code (str): The Mobile Country Code (MCC) as described in the ITUs E.212 specification.. [optional]  # noqa: E501
            mobile_network_code (str): The Mobile Network Code (MNC) as described in the ITUs E.212 specification.. [optional]  # noqa: E501
            subscription_identification_number (str): The Mobile Subscription Identification Number code (MSIN) as described in the ITUs E.212 specification.. [optional]  # noqa: E501
            location_area_code (str): The Location Area Code (LAC) is a 16-bit identifier for a region that is covered by a set of network antennas.. [optional]  # noqa: E501
            cell_id (str): The Cell ID (CID) is identifier for a specific Base Transceiver Station (BTS) within a specific Location Area Code (LAC).. [optional]  # noqa: E501
            standard (str): An identifier of the network standard used.. [optional]  # noqa: E501
            mac (str): The MAC address of the device that is connected to the Wi-Fi network.. [optional]  # noqa: E501
            ssid (str): The Wi-Fi networks Service Set Identifier (SSID).. [optional]  # noqa: E501
            bssid (str): The Wi-Fi networks Basic Service Set Identifier (BSSID).. [optional]  # noqa: E501
            user_defined (object): A JSON object that can carry any additional information about the network that might be helpful for fraud detection.. [optional]  # noqa: E501
        """
        ...
        if ip is not None:
            self.ip = ip  # noqa: E501
        if phone_number is not None:
            self.phone_number = phone_number  # noqa: E501
        if carrier_name is not None:
            self.carrier_name = carrier_name  # noqa: E501
        if mobile_country_code is not None:
            self.mobile_country_code = mobile_country_code  # noqa: E501
        if mobile_network_code is not None:
            self.mobile_network_code = mobile_network_code  # noqa: E501
        if subscription_identification_number is not None:
            self.subscription_identification_number = subscription_identification_number  # noqa: E501
        if location_area_code is not None:
            self.location_area_code = location_area_code  # noqa: E501
        if cell_id is not None:
            self.cell_id = cell_id  # noqa: E501
        if standard is not None:
            self.standard = standard  # noqa: E501
        if mac is not None:
            self.mac = mac  # noqa: E501
        if ssid is not None:
            self.ssid = ssid  # noqa: E501
        if bssid is not None:
            self.bssid = bssid  # noqa: E501
    ...
    def subscription_identification_number(
        ...
        self._subscription_identification_number = (
            subscription_identification_number)
