...
class ClearingDetails(object):
    ...
    attribute_map = {
        'clearing_elements': 'clearingElements',  # noqa: E501
        'batch_time_stamp': 'batchTimeStamp',  # noqa: E501
        'receipt_number_from': 'receiptNumberFrom',  # noqa: E501
        'receipt_number_to': 'receiptNumberTo',  # noqa: E501
    ...
    def __init__(self, clearing_elements=None, batch_time_stamp=None, receipt_number_from=None, receipt_number_to=None, trace_number=None):  # noqa: E501
        """ClearingDetails - a model defined in OpenAPI



        Keyword Args:
            clearing_elements (list[ClearingElement]): The array contains information about the clearing elements.. [optional]  # noqa: E501
            batch_time_stamp (str): Timestamp when the clearing has been processed. The used format is \&quot;YYYYMMDDhhmmss\&quot;.. [optional]  # noqa: E501
            receipt_number_from (int): Start receipt number for the clearing process.. [optional]  # noqa: E501
            receipt_number_to (int): End receipt number for the clearing process.. [optional]  # noqa: E501
            trace_number (int): Trace number for the clearing process.. [optional]  # noqa: E501
        """
        ...
        if clearing_elements is not None:
            self.clearing_elements = clearing_elements  # noqa: E501
        if batch_time_stamp is not None:
            self.batch_time_stamp = batch_time_stamp  # noqa: E501
        if receipt_number_from is not None:
            self.receipt_number_from = receipt_number_from  # noqa: E501
        if receipt_number_to is not None:
            self.receipt_number_to = receipt_number_to  # noqa: E501
        if trace_number is not None:
            self.trace_number = trace_number  # noqa: E501
