...
class PrimaryTransaction(object):
    ...
    def __init__(self, request_type, transaction_amount, store_id=None, merchant_transaction_id=None, transaction_origin=None, order=None):  # noqa: E501
        """PrimaryTransaction - a model defined in OpenAPI
