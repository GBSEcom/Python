...
class PurchaseCardsLevel2(object):
    ...
    attribute_map = {
        ...
        'supplier_invoice_number': 'supplierInvoiceNumber',  # noqa: E501
        'supplier_vat_registration_number': 'supplierVATRegistrationNumber',  # noqa: E501
        'total_discount_amount_and_rate': 'totalDiscountAmountAndRate',  # noqa: E501
        'vat_shipping_amount_and_rate': 'vatShippingAmountAndRate',  # noqa: E501
    }
    ...
    def __init__(self, customer_reference_id=None, supplier_invoice_number=None, supplier_vat_registration_number=None, total_discount_amount_and_rate=None, vat_shipping_amount_and_rate=None):  # noqa: E501
        """PurchaseCardsLevel2 - a model defined in OpenAPI



        Keyword Args:
            customer_reference_id (str): Customer code/customer reference ID.. [optional]  # noqa: E501
            supplier_invoice_number (str): Purchase identifier/merchant-related data.. [optional]  # noqa: E501
            supplier_vat_registration_number (str): Merchant VAT registration/single business reference number/merchant tax ID or corporation VAT number.. [optional]  # noqa: E501
            total_discount_amount_and_rate (AdditionalAmountRate): [optional]  # noqa: E501
            vat_shipping_amount_and_rate (AdditionalAmountRate): [optional]  # noqa: E501
        """
        ...
        if customer_reference_id is not None:
            self.customer_reference_id = customer_reference_id  # noqa: E501
        if supplier_invoice_number is not None:
            self.supplier_invoice_number = supplier_invoice_number  # noqa: E501
        if supplier_vat_registration_number is not None:
            self.supplier_vat_registration_number = supplier_vat_registration_number  # noqa: E501
        if total_discount_amount_and_rate is not None:
            self.total_discount_amount_and_rate = total_discount_amount_and_rate  # noqa: E501
        if vat_shipping_amount_and_rate is not None:
            self.vat_shipping_amount_and_rate = vat_shipping_amount_and_rate  # noqa: E501
    ...
    def supplier_vat_registration_number(
            self,
        ...
        self._supplier_vat_registration_number = (
            supplier_vat_registration_number)
    ...
    def total_discount_amount_and_rate(
            self,
            total_discount_amount_and_rate):
        ...
        self._total_discount_amount_and_rate = (
            total_discount_amount_and_rate)
    ...
    def vat_shipping_amount_and_rate(
            self,
            vat_shipping_amount_and_rate):
        ...
        self._vat_shipping_amount_and_rate = (
            vat_shipping_amount_and_rate)
