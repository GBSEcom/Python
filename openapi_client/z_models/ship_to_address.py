...
class ShipToAddress(object):
    ...
    def __init__(self, phone=None, address1=None, address2=None, city=None, state=None, zip=None, country=None):  # noqa: E501
        """ShipToAddress - a model defined in OpenAPI



        Keyword Args:
            phone (str): Free-form phone number associated with the ship-to address.. [optional]  # noqa: E501
            ...
            state (str): State or province.. [optional]  # noqa: E501
            zip (str): Postal Code, free form.. [optional]  # noqa: E501
