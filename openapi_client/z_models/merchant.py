...
class Merchant(object):
    ...
    attribute_map = {
        'merchant_unique_id': 'merchantUniqueId',  # noqa: E501
        'mcc': 'mcc',  # noqa: E501
        'location': 'location',  # noqa: E501
        'user_defined': 'userDefined',  # noqa: E501
    }

    def __init__(self, merchant_unique_id, mcc=None, location=None, user_defined=None):  # noqa: E501
        ...
        Keyword Args:  # noqa: E501
            mcc (str): The 4-digit Merchant Category Code. The merchant might be associated with multiple MCCs. In that case the MCC provided here will be the one that better describes the current transaction.. [optional]  # noqa: E501
            location (Location): [optional]  # noqa: E501
            user_defined (object): A JSON object that can carry any additional information about the merchant that might be helpful for fraud detection.. [optional]  # noqa: E501
        """
        ...
        if location is not None:
            self.location = location  # noqa: E501
