...
class FraudRegistration(object):
    ...
    def __init__(self, transaction_type, customer, merchant, merchant_ref=None, device=None, user_defined=None):  # noqa: E501
        """FraudRegistration - a model defined in OpenAPI
