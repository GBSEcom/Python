...
class Secure3D21AuthenticationResult(object):
    ...
    def __init__(self, authentication_type, cavv=None, xid=None, transaction_id=None, authentication_response=None, transaction_status=None):  # noqa: E501
        """Secure3D21AuthenticationResult - a model defined in OpenAPI
