...
class EncryptedSamsungPay(object):
    ...
    def __init__(self, data, version=None):  # noqa: E501
        """EncryptedSamsungPay - a model defined in OpenAPI

        Args:
            data (str): The encrypted wallet payload.

        Keyword Args:  # noqa: E501
            version (str): Identifies under which encryption/signing scheme this message has been created. In this way, the protocol can evolve over time if needed. For Google Payments transactions, this should be set to ECv1.. [optional]  # noqa: E501
        """
