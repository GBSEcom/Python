...
class SepaMandate(object):
    ...
    def __init__(self, reference=None, url=None, signature_date=None, type='SINGLE'):  # noqa: E501
        """SepaMandate - a model defined in Swagger"""  # noqa: E501
    ...
    def reference(self, reference):
        ...
        if reference is not None and not re.search('[A-Za-z0-9:?\/+(),. -]{1,35}', reference):  # noqa: E501
            raise ValueError("Invalid value for `reference`, must be a follow pattern or equal to `/[A-Za-z0-9:?\/+(),. -]{1,35}/`")  # noqa: E501
