...
class StoredCredential(object):
    ...
    def __init__(self, sequence=None, scheduled=None, referenced_scheme_transaction_id=None, initiator=None):  # noqa: E501
        """StoredCredential - a model defined in Swagger"""  # noqa: E501
    ...
    def scheduled(self):
        ...
        Indicates if the transaction is scheduled or part of a installment  # noqa: E501
    ...
    def initiator(self):
        ...
        Indicates whether it is a merchant initiated or explicitly consented by card holder. Valid values are 'MERCHANT' and 'CARDHOLDER'  # noqa: E501
